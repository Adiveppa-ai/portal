 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTRemoveReference.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \brief
 * Removes an lvalue or rvalue reference from a type
 *
 * Specifies a typedef to \c T1 if \c T is "a reference to \c T1"; otherwise
 * \c T.
 *
 * \example
 * \code

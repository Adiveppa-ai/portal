/* @(#)%Portal Version: FlistBinstrType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:43:46 % */
#ifndef EDR_FLISTBINSTRTYPE_HPP
#define EDR_FLISTBINSTRTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class FlistBinstrType.
//
//------------------------------------------------------------------------------
...
namespace EDR
{
/** <b><tt>FlistBinstrType</tt></b> is the FLIST_Binstr datatype used in input files.
 *
 */
class FlistBinstrType : public FlistFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    FlistBinstrType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~FlistBinstrType();

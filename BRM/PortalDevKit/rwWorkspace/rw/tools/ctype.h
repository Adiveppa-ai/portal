...
/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/ctype.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \note
 * This function differs from the C Standard Library function in that it
 * does not take the current locale in to account. This function's behavior
 * is consistent with the "C" locale.
 */

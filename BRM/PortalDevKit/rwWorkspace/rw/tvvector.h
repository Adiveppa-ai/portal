 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tvvector.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWTValVector is a simple parameterized vector of objects of type
 * \c T. It is most useful when you know precisely how many objects have to
 * be held in the collection. If the intention is to "insert" an unknown
 * number of objects, then class RWTValOrderedVector may be a better choice.
 *
...
public:
    ...
    /**
     * Constructs a vector of length \a n. The values of the elements are
     * set by the default constructor of class #value_type.
     */
    ...
    /**
     * Constructs a vector of length \a n, with each element initialized to
     * the value \a ival.
     */
    RWTValVector(size_type n, const_reference ival);

    /**
     * Constructs self as a copy of \a rhs. Each element in \a rhs is copied
     * into self.
     */
     ...
     * elements is set by the default constructor of #value_type.
     */
     ...
     * Index \a i should be between \c 0 and one less than the number of
     * entries, otherwise the results are undefined.
     *
     * \note

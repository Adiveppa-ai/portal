#!/home/pin/opt/portal/Thirdparty/perl-5.38.2/bin/perl/bin/perl
# 
...
if ((!defined($ARGV[0])) || (!-e "__BRM_HOME__/$ARGV[0]/pin.conf"))
{
exit;
}

open FILE, "__BRM_HOME__/$ARGV[0]/pin.conf"  or die $!;
open FILEDUMP, ">__BRM_HOME__/$ARGV[0]/pin.conf_1"  or die $!;
...
system("mv __BRM_HOME__/$ARGV[0]/pin.conf_1 __BRM_HOME__/$ARGV[0]/pin.conf ");

 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTIsClass.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \brief
 * Determines if a type is a non-union class type
 *
 ...
 * types. In order to prevent this, RWTIsUnion must be specialized for union
 * types to derive from RWTrueType. The macro \c RW_NO_PRIMITIVE_IS_UNION

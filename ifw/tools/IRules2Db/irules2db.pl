#!/usr/bin/perl
#===============================================================================
# @(#)$Id: irules2db.pl /cgbubrm_mainbrm.pipeline/1 2021/05/05 01:21:48 mkothari Exp $
#
...
getopts("f");
if ( ($#ARGV != 2) && ($#ARGV != 3) ) {
    print STDERR "usage: irules2db.pl [-f] <dbsn> <username> <filename> [<filepath>]\n\n";
    ...
    print STDERR "Example: irules2db.pl dbi:Oracle:db_alias scott TAP3_VAL.xml\n";
    print STDERR "Example: irules2db.pl -f dbi:Oracle:db_alias scott ./TAP3_VAL.xml /usr/home/xmlfiles\n\n";
...
if ($DEBUG) {
    print "dbsn=$dbsn; user=$user; pass=****; filename=$filename;  filepath=$filepath\n";
}

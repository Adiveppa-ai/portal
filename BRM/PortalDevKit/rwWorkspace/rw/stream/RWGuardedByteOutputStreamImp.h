#ifndef rw_stream_RWGuardedByteOutputStreamImp_h_
#define rw_stream_RWGuardedByteOutputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWGuardedByteOutputStreamImp.h#1 $
 *
 ...
 *
 * \headerfileloc{#include <rw/stream/RWGuardedByteOutputStreamImp.h>}
 *
 * The typedef #RWGuardedByteOutputStreamImp implements a simple binary
 * guard output stream. The output stream guard acquires the synchronization
 ...
 *
 * A \ref rwGuard(RWByteOutputStream&) "rwGuard()" manipulator creates a
 ...
 * synchronized stream, the \ref rwGuard(RWByteOutputStream&) "rwGuard()"
 ...
 * \endexample
 */
RWByteOutputStream RW_STREAM_SYMBOLIC rwGuard(RWByteOutputStream& stream);

#endif // rw_stream_RWGuardedByteOutputStreamImp_h_

/* @(#)%Portal Version: FlistDecimalType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:44:02 % */
#ifndef EDR_FLISTDECIMALTYPE_HPP
#define EDR_FLISTDECIMALTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class FlistDecimalType.
//
//------------------------------------------------------------------------------
...
namespace EDR
{
/** <b><tt>FlistDecimalType</tt></b> is the FLIST_Decimal datatype used in input files.
 *
 */
class FlistDecimalType : public FlistFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    FlistDecimalType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~FlistDecimalType();
  ...
  private:
    ...
    BAS::String digitBufferM;
};
}
#endif // FLISTDECIMALTYPE

#ifndef __rw_mime_pkgdefs_h__
#define __rw_mime_pkgdefs_h__

/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/mime/pkgdefs.h#1 $
 *
...
#include <rw/config/rwconfig_mime.h>
...
//////////////////////////////////////////////////////////////////////////////
#if defined(_RWBUILD_mime)
#  define RW_MIME_BUILD
#endif
...
#  if defined(RW_MIME_BUILD)
#    define RW_MIME_GLOBAL                      RW_COMPILER_GLOBAL_EXPORT
#    define RW_MIME_SYMBOLIC                    RW_COMPILER_SYMBOLIC_EXPORT
#  else
#    define RW_MIME_GLOBAL                      RW_COMPILER_GLOBAL_IMPORT
#    define RW_MIME_SYMBOLIC                    RW_COMPILER_GLOBAL_IMPORT
#  endif
#else
#  define RW_MIME_GLOBAL
#  define RW_MIME_SYMBOLIC
#endif
...
#define RW_MIME_IDENT \
  static const char rw_mime_ident[] = "\"@(#)\trw/mime:" __FILE__ " " __DATE__ " " __TIME__ "\""; \
  inline void rw_use_mime_ident(void) { RW_UNUSED(rw_mime_ident); }

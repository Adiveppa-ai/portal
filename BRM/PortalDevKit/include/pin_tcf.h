...
typedef enum {
	...
	PIN_ACTION_ADD          = 1,
	PIN_ACTION_MODIFY       = 2,
	PIN_ACTION_INVALID      = 10000 
	/*PIN_ACTION_INVALID is added just to assign it as default value. 
	 * we have added larger value so that if tomorrow if new vallues are added we dont have to modify 
	 * PIN_ACTION_INVALID*/

...
#=============================================================
#  @$Id: pin_cmp_storable_class_to_xml.pl /cgbubrm_mainbrm.portalbase/7 2018/08/09 01:42:18 anirbisw Exp $
# 
...
sub configure_storable_class_to_xml_config_files {
  ...
  if ( ! -e "$PIN_HOME/apps/storable_class_to_xml" ){
   ...
   &Configure_Infranet("$PIN_HOME/apps/storable_class_to_xml/Infranet.properties");
   ...
   chmod 0640, "$PIN_HOME/apps/storable_class_to_xml/Infranet.properties";
   ...
   $Cmd = &FixSlashes($header."\n" 
		       .$Pref."/home/pin/opt/portal/Thirdparty/jdk1.8.0_401/bin/java -cp \"$PIN_HOME/jars/storableclasstoxml.jar".$Sep

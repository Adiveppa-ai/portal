 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tislist.h#1 $
 *
 **********************************************************************
 *
 ...
 * common base class, in this case RWIsvSlink. The advantage of such a list
 ...
 * use with an existing class. Class RWTValSlist is offered as an
...
#  endif
    ...
    /**
     * Returns (but does not remove) the first item in the list, or #rwnil
     ...
     * once, this function can return only zero or one.
     */
     ...
     * no items in the list. Note that this function is relatively slow
    ...
    /**
     * Removes and returns the link with address \a a. The link must be in
     * the list. In a singly-linked list this function is not very
     * efficient.
     */
 ...
 *
 * \brief
 * Iterator for class RWTIsvSlist
 *
 * RWTIsvSlistIterator provides an iterator interface for class RWTIsvSlist,
 * allowing sequential access to all the elements of a singly-linked
 * parameterized intrusive list. Elements are accessed in order, from first
 * to last.
 *
...
public:
    ...
    /**
     * Advances the iterator to the first link for which the function
     ...
     * removed link. This function is relatively inefficient for a
     * singly-linked list.
     */

 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/scopeguard.h#1 $
 *
 ***************************************************************************/
...
public:
    /**
     * Dismisses the action associated with this RWScopeGuardImp instance,
     * so that the action does not execute at the end of the current scope.
     */
    void dismiss() const
    {
        dismissed_ = true;
...
protected:
    ...
    /**
     * Copy constructor. Transfers responsibility for invoking the
     * associated action to self, and dismisses \a other.
     */
 ...
 * \ingroup tools_scopeguard_group
 *
 * #RWScopeGuard encapsulates a function to invoke and a set of parameters
 * to pass to that function on exit from the current local scope. It can
 * handle functions that take up to five parameters, and those parameters
 * can be of any type.
 *
 * \example
 * \code
 ...
 * \endcode
 *
 * If the action to be performed by the scope guard is no longer necessary,
 * it may be canceled.
 *
 * \code
 ...
 *
 * Derived RWScopeGuardImp for global or static member functions that take 0
 * parameters. This class should not be used directly; rather, use the
 * typedef #RWScopeGuard and the rwtMakeScopeGuardG() convenience functions.
 *
 * \sa
 ...
 *
 * Derived RWScopeGuardImp for global or static member functions that take 1
 * parameter. This class should not be used directly; rather, use the
 * typedef #RWScopeGuard and the rwtMakeScopeGuardG() convenience functions.
 *
 * \sa
 * rwtMakeScopeGuardG, #RWScopeGuard
...
/**
 * \ingroup tools_scopeguard_functions
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a func()</tt> automatically when control flow leaves the current
 * scope.
 */
template <class Func>
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a func(a1)</tt> automatically when control flow leaves the current
 * scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a func(a1,a2)</tt> automatically when control flow leaves the
 * current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a func(a1,a2,a3)</tt> automatically when control flow leaves the
 * current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a func(a1,a2,a3,a4)</tt> automatically when control flow leaves the
 * current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a func(a1,a2,a3,a4,a5)</tt> automatically when control flow leaves
 * the current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a obj.\a func()</tt> automatically when control flow leaves the
 * current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a obj.\a func(a1)</tt> automatically when control flow leaves the
 * current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a obj.\a func(a1,a2)</tt> automatically when control flow leaves the
 * current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a obj.\a func(a1,a2,a3)</tt> automatically when control flow leaves
 * the current scope.
 */
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a obj.\a func(a1,a2,a3,a4)</tt> automatically when control flow
 ...
 *
 * Template function to create an #RWScopeGuard set to call
 * <tt>\a obj.\a func(a1,a2,a3,a4,a5)</tt> automatically when control flow
 * leaves the current scope.
 */

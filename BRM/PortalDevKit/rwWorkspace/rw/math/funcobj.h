 ...
 * funcobj.h
 *
 * $Id: //spro/rel2016.1/rw/math/funcobj.h#1 $
 *
...
RW_MATH_SPECIALIZE
struct RW_acos<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(acos(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_acos<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(acos(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_asin<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(asin(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_asin<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(asin(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_atan<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(atan(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_atan<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(atan(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_atan2<signed char, signed char, signed char> {
    inline signed char operator()(const signed char& x, const signed char& y)
    {
        return (signed char)(atan2(double(x), double(y)));
    }
};

RW_MATH_SPECIALIZE
struct RW_atan2<unsigned char, unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x, const unsigned char& y)
    {
        return (unsigned char)(atan2(double(x), double(y)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_ceil<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return x;
    }
...
RW_MATH_SPECIALIZE
struct RW_ceil<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return x;
    }
...
RW_MATH_SPECIALIZE
struct RW_cos<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(cos(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_cos<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(cos(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_cosh<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(cosh(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_cosh<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(cosh(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_exp<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(exp(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_exp<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(exp(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_floor<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return x;
    }
...
RW_MATH_SPECIALIZE
struct RW_floor<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return x;
    }
...
RW_MATH_SPECIALIZE
struct RW_log<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(log(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_log<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(log(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_log10<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(log10(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_log10<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(log10(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_sin<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(sin(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_sin<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(sin(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_sinh<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(sinh(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_sinh<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(sinh(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_sqrt<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(sqrt(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_sqrt<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(sqrt(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_tan<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(tan(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_tan<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(tan(double(x)));
    }
};
...
RW_MATH_SPECIALIZE
struct RW_tanh<unsigned char, unsigned char> {
    inline unsigned char operator()(const unsigned char& x)
    {
        return (unsigned char)(tanh(double(x)));
    }
};

RW_MATH_SPECIALIZE
struct RW_tanh<signed char, signed char> {
    inline signed char operator()(const signed char& x)
    {
        return (signed char)(tanh(double(x)));
    }
};

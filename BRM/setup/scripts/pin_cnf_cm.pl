#=======================================================================
# @(#)$Id: pin_cnf_cm.pl vmoteth_bug-28988081/2 2019/03/22 01:44:12 vmoteth Exp $ 
# 
...
#    0 - TLS is disabled.
#    1 - TLS is enabled.
#    2 - TLS is enabled between BRM clients and CM
#
##========================================================================
END
        ,"enable_ssl", "- cm enable_ssl $ENABLE_SSL"
        ,"ssl_auth_description", <<END
#========================================================================
# ssl_auth
#
# To enable two-way server and client authentication between the CM and 
# the PCM client, uncomment the following entry.The PCM client must have
# a certificate in the client wallet to present to CM 
#
# This is an optional entry.
#
##========================================================================
END
        ,"ssl_auth", "#- cm ssl_auth 2-way"
        ,"wallet_description", <<END
#========================================================================
# wallet
#
# This entry specifies the location of the Oracle wallet used by CM for 
...
##========================================================================
END
        ,"wallet", "#- cm wallet $PIN_HOME/wallet/server"
        ,"cipher_description", <<END
#========================================================================
# cipher
#
# This entry specifies the cipher suites enabled by CM for TLS 
# connections.To add multiple cipher suites, separate each cipher suite 
# by a comma. 
#
# This is an optional entry.
#
##========================================================================
END
        ,"cipher", "#- cm cipher SSL_RSA_WITH_AES_128_CBC_SHA"
        ,"fm_perflib_description", <<END
#========================================================================
# Perflib FM
#
# Enable CM monitoring using Perflib
#
# This is an optional entry.
#
##========================================================================
END
        ,"fm_perflib", "#- cm fm_module ${PIN_HOME}/lib/fm_perflib.so fm_perflib_config - pin"
        ,"perflib_description", <<END
#========================================================================
# 
# PERFLIB_DATA_FILE - Control file for each application which is being
# traced. There must be ONE file per process
#
##========================================================================
END
        ,"perflib", "#- perflib_monitor_file perflib_data ${PIN_HOME}/apps/perflib/perflib_data.dat"
        ,"perflib_shlib_description", <<END
#========================================================================
# perflib_shlib  
#
# Define the full path to the shared library in which core
# BRM functionality for CMs and applications are defined. This is necessary
# to locate some flist management functions which the PerfLib needs to access.
##========================================================================
END
        ,"perflib_shlib", "#- perflib perflib_pin_shlib ${PIN_HOME}/lib/libcmpin.so"
...
END
	...
	,"cm_die_on_exception_description",  <<END
#========================================================================
# cm_die_on_exception
#
# Used to decide whether to generate core dump/stack trace on the event of any segmentation fault(SIGSEGV)
#
# calling of custom sigsegv_handler will help to fetch the stack trace in cm.pinlog
#
# The value of this entry can be
#     0 = Will generate the stack trace of core in CM log
#     1 = Will not generate the code stack trace of core in CM log
#========================================================================
END
	,"cm_die_on_exception", "- cm die_on_exception 1"
...
END
      ...
      ,"pin_job_executor_em_group_description", <<END
#========================================================================
# pin_job_executor_em_group
#
# Defines a member opcode in a group of opcodes provided by an
# External Manager (EM).
#
...
#========================================================================
END
      ,"pin_job_executor_em_group", "- cm em_group pje PCM_OP_JOB_EXECUTE"
      ,"pin_job_executor_em_pointer_description", <<END
#========================================================================
# pin_job_executor_em_pointer
#
# Specifies where to find the External Manager(s) that provide other
# opcodes to the CM.
#
...
#========================================================================
END
      ,"pin_job_executor_em_pointer", "- cm em_pointer pje ip $CM{'hostname'} $PJE{'port'}"
...
- cm fm_module \$\{PIN_HOME\}/lib/fm_contract\$\{LIBRARYEXTENSION\} fm_contract_config$FM_FUNCTION_SUFFIX fm_contract_init pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_contract_pol\$\{LIBRARYEXTENSION\} fm_contract_pol_config$FM_FUNCTION_SUFFIX fm_contract_pol_init pin
...
- cm fm_module \$\{PIN_HOME\}/lib/fm_job\$\{LIBRARYEXTENSION\} fm_job_config$FM_FUNCTION_SUFFIX - pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_job_pol\$\{LIBRARYEXTENSION\} fm_job_pol_config$FM_FUNCTION_SUFFIX - pin
...
- cm fm_module \$\{PIN_HOME\}/lib/fm_loan\$\{LIBRARYEXTENSION\} fm_loan_config$FM_FUNCTION_SUFFIX - pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_loan_pol\$\{LIBRARYEXTENSION\} fm_loan_pol_config$FM_FUNCTION_SUFFIX - pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_notification\$\{LIBRARYEXTENSION\} fm_notification_config fm_notification_init pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_notification_pol\$\{LIBRARYEXTENSION\} fm_notification_pol_config - pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_deposit\$\{LIBRARYEXTENSION\} fm_deposit_config - pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_deposit_pol\$\{LIBRARYEXTENSION\} fm_deposit_pol_config - pin
...
#
# This parameter will be converted as a business parameter in the 
# future and this entry will be removed. So make sure this value
# also updated in bus_params_billing.xml:CycleTaxInterval
#========================================================================
END
...
#    2 = The tax calculation at billing time, using event time tax rate.
#    3 = The tax is not calculated, used with business param itemized_tax_calculation
#
...
# minimum_payment
#
# Specifies the minimum payment amount.
#    2.00 = (Default)
#========================================================================
END
	,"pol_minimum_threshold", "- fm_pymt_pol minimum_payment $CM{'min_balance'}"

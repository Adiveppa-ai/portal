#ifndef rw_stream_RWGuardedUCharOutputStreamImp_h_
#define rw_stream_RWGuardedUCharOutputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWGuardedUCharOutputStreamImp.h#1 $
 *
 ...
 *
 * The typedef #RWGuardedUCharOutputStreamImp implements a simple Unicode
 * character guard output stream. The output stream guard acquires the
 * synchronization mechanism provided by its sink stream at construction
 * time, and releases it upon destruction. The output guard stream doesn't
 ...
 * implement any synchronization mechanism, the output stream guard class
 * has no effect. The guard class is generally used in combination with
 * class RWSynchronizedUCharOutputStreamImp.
 *
 * \code
 ...
 *
 * \headerfileloc{#include <rw/stream/RWGuardedUCharOutputStreamImp.h>}
 *
 ...
 *
 * A \ref rwGuard(RWUCharOutputStream&) "rwGuard()" manipulator creates a
 ...
 * synchronized stream, the \ref rwGuard(RWUCharOutputStream&) "rwGuard()"
 ...
 * \endcode
 */
RWUCharOutputStream RW_STREAM_SYMBOLIC rwGuard(RWUCharOutputStream& stream);

#endif // rw_stream_RWGuardedUCharOutputStreamImp_h_

#ifndef __rw_pop3_pkgdefs_h__
#define __rw_pop3_pkgdefs_h__

/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/pop3/pkgdefs.h#1 $
 *
...
#include <rw/config/rwconfig_pop3.h>
...
//////////////////////////////////////////////////////////////////////////////
#if defined(_RWBUILD_pop3)
#  define RW_POP3_BUILD
#endif
...
#  if defined(RW_POP3_BUILD)
#    define RW_POP3_GLOBAL                      RW_COMPILER_GLOBAL_EXPORT
#    define RW_POP3_SYMBOLIC                    RW_COMPILER_SYMBOLIC_EXPORT
#  else
#    define RW_POP3_GLOBAL                      RW_COMPILER_GLOBAL_IMPORT
#    define RW_POP3_SYMBOLIC                    RW_COMPILER_GLOBAL_IMPORT
#  endif
#else
#  define RW_POP3_GLOBAL
#  define RW_POP3_SYMBOLIC
#endif
...
#define RW_POP3_IDENT \
  static const char rw_pop3_ident[] = "\"@(#)\trw/pop3:" __FILE__ " " __DATE__ " " __TIME__ "\""; \
  inline void rw_use_pop3_ident(void) { RW_UNUSED(rw_pop3_ident); }

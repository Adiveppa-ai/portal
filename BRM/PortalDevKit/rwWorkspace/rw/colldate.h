 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/colldate.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Collectable Dates. Inherits from classes RWDate and RWCollectable. This
...
public:
    ...
    /**
     * Returns the results of calling operator==() for the base class RWDate

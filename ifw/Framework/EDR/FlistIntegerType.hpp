/* @(#)%Portal Version: FlistIntegerType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:43:54 % */
#ifndef EDR_FLISTINTEGERTYPE_HPP
#define EDR_FLISTINTEGERTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class FlistIntegerType.
//
//------------------------------------------------------------------------------
...
namespace EDR
{
/** <b><tt>FlistIntegerType</tt></b> is the FLIST_Integer datatype used in input files.
 *
 */
class FlistIntegerType : public FlistFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    FlistIntegerType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~FlistIntegerType();

# @(#)%Portal Version: pin_cnf_pin_bill.pl:InstallVelocityInt:4:2005-Mar-25 18:12:18 %
#=======================================================================
#  @(#)%Portal Version: pin_cnf_pin_bill.pl:InstallVelocityInt:4:2005-Mar-25 18:12:18 %
# 
...
END
	...
	,"pin_gen_notifications_performance_description", <<END
#======================================================================
# Performance Parameters for pin_gen_notifications
#
# These parameters govern how the MTA application pin_gen_notifications
# pulls data from the  database and tranfers it to the application space.
# They also define how many threads (children) are used to process the data in
# the application.
#
#  -- children:   number of threads used to process the accounts in the
#                 application
...
#======================================================================
END
	,"pin_gen_notification_performance"
	,"- pin_gen_notifications       children        5
- pin_gen_notifications       per_batch       500
- pin_gen_notifications       per_step        1000
- pin_gen_notifications       fetch_size      5000"
	,"pin_gen_notifications_log_description", <<END
#========================================================================
# pin_gen_notifications_log
#
# Specifies the full path to the log file used by this MTA application
# pin_gen_notifications and the log level.
#
# You can enter any valid path and loglevel.
#========================================================================
END
	,"pin_gen_notifications_log", "- pin_gen_notifications logfile \$\{PIN_LOG_DIR\}/pin_billd/pin_gen_notifications.pinlog
- pin_gen_notifications loglevel 1"

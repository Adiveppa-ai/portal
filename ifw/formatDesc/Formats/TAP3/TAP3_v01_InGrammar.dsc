...
//------------------------------------------------------------------------------
// Module Description:
//   Input grammar file for the TAP3_v01 CDR format
//
// Open Points:
//   <open points>
//
...
//
// $RCSfile: TAP3_v01_InGrammar.dsc,v $
// $Revision: 1.37 $
// $Author: cdiab $
// $Date: 2001/11/22 15:59:37 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: TAP3_v01_InGrammar.dsc,v $
// Revision 1.37  2001/11/22 15:59:37  cdiab
// PETS #41974: TAP3 ChargePacket wrongly flaged as Alternative
//
// Revision 1.36  2001/11/22 15:20:12  cdiab
// PETS #41974: TAP3 ChargePacket wrongly flaged as Alternative
//
// Revision 1.35  2001/11/21 15:17:17  cdiab
...
//
// Revision 1.34  2001/11/15 15:12:36  cdiab
...
//
// Revision 1.33  2001/11/13 11:42:38  cdiab
// PETS #40773 : CAMEL support for V4.30
//
// Revision 1.32  2001/10/25 12:55:44  cdiab
...
//
// Revision 1.31  2001/10/23 18:10:00  cdiab
// PETS #40891: TAP3 parse error : v04 read / v01 v04 write
//
// Revision 1.30  2001/10/19 11:39:37  cdiab
...
//
// Revision 1.29  2001/10/19 09:11:25  cdiab
// PETS #40694: some errors are still in the TAP3 processing
...
//
// Revision 1.28  2001/10/18 16:31:28  cdiab
// PETS #40694: some errors are still in the TAP3 processing
...
//
// Revision 1.27  2001/10/11 12:14:45  cdiab
...
//
// Revision 1.26  2001/10/11 10:57:44  cdiab
...
//
// Revision 1.24  2001/10/09 15:27:24  cdiab
...
//
// Revision 1.23  2001/10/01 16:27:25  cdiab
...
//
// Revision 1.22  2001/09/21 13:02:22  cdiab
...
//
// Revision 1.21  2001/09/20 12:08:14  cdiab
...
//
// Revision 1.20  2001/09/19 16:27:25  cdiab
// PETS #39644: be able to normalize a TelNum using arrays for CC and IAC
// now using convertCli2 for number normalization
//
// Revision 1.19  2001/09/14 15:00:54  cdiab
...
//
// Revision 1.18  2001/09/14 14:16:54  cdiab
...
//
// Revision 1.17  2001/09/06 10:45:10  cdiab
...
//
// Revision 1.16  2001/09/05 12:25:13  cdiab
// PETS #38966 : add indefinite length object ability to Tap-0301
// modified TAP3_v01_InGrammar.dsc and TAP3_v01_Blocks.dsc
//
...
// processing time.
//
// Revision 1.11  2001/06/07 08:10:44  cdiab
// - input and output OK (looping generated output on input works)
//
// Revision 1.10  2001/06/06 12:40:03  cdiab
...
//
// Revision 1.8  2001/06/01 15:33:58  cdiab
// backup - and Charge information is partly build on output.
//
// Revision 1.7  2001/05/31 15:34:55  cdiab
// error in last commit, Exchange rate was forced to 1.0 (ie test setting)
//
// Revision 1.6  2001/05/31 15:32:42  cdiab
// store more data for SCU (mandatory for output side afterwards)
//
// Revision 1.5  2001/05/30 15:10:14  cdiab
// small modifs, and new mapping for ORIGINATING_SWITCH_IDENTIFICATION.
//
...
// last CP).
//
// Revision 1.3  2001/05/28 14:57:33  cdiab
// all OK for input!
//
// Revision 1.2  2001/05/28 12:10:51  cdiab
// previous version processed ChargeDetail only for BasicServices.
//
...
//logStdout( "ERROR: unknown detail type: "+longToStr(detailTypedId)+"\n" ); 
  ...
  function storeChargeInfoTempFields
  {
    if (successiveChargeInformation >= 1)
    {
      ...
      edrString(DETAIL.CONNECT_TYPE)			= lastCallType;
      edrString(DETAIL.CONNECT_SUB_TYPE)		= lastCallTypeSubtype;
...
//logStdout( "  Start Tap0301 input :  " + dateToStr(startTime)+ "\n");         //TODO remove this line or just comment it
//logStdout( "  End   Tap0301 input :  " + dateToStr(stopTime) + "\n");         //TODO remove this line or just comment it
...
//logStdout( "record_Trailer #"+longToStr(records)+"\n" ); //TODO comment or remove
  ...
  callType_opt:
      IFW_TAP3.CallType
      {
        lastCallType        = tokenString("IFW_TAP3.CallType.CALL_TYPE");
      }
    | /* EMPTY */
      {
        lastCallType        = "";
  ...
  callTypeSubtype_opt:
      ...
      {
        lastCallTypeSubtype = tokenString("IFW_TAP3.CallTypeSubtype.CALL_TYPE_SUBTYPE");
      }
    | /* EMPTY */
      {
        lastCallTypeSubtype = "";
...
//		  edrString(DETAIL.C_NUMBER)                 = lastThirdPartyNumber;
  ...
  taxInformation:
	...
	if (getTaxRate(tokenLong("IFW_TAP3.TaxCode.TAX_CODE")) != "")
	{
	  lastTaxRate  = strToLong( getTaxRate(tokenLong("IFW_TAP3.TaxCode.TAX_CODE")) );
        }
      }
      IFW_TAP3.Charge
      {

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/regex/defs.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * Defines static, inline methods for returning specific regular expression
 * character values.
 *
 * Class RWTRegexTraits defines static, inline methods for returning
 * specific RE character values. These values \e must be defined and include
 *
 * - each of the regular expression special characters
 * - numeric and hex digits
 * - some escape sequences
 *
 * In addition, any class used as a traits class \e must define some special
 * methods for converting and comparing characters.
 *
 * \synopsis

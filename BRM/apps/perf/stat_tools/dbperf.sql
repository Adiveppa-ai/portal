--  Continuus file information --- %full_filespec: dbperf.sql~2:sql:1 %
SET ECHO off 
REM NAME:   TFSDBPER.SQL 
REM USAGE:"@path/tfsdbper" 
REM ------------------------------------------------------------------------- 
REM REQUIREMENTS: 
REM   DBA Role 
REM  
REM ------------------------------------------------------------------------- 
REM AUTHOR:  
REM    Mark D. Scull (June 20, 1996)      
REM    Last Modified:  July 1, 1996      
REM ------------------------------------------------------------------------- 
REM PURPOSE: 
REM    This script generates a report which provides an overview of the 
REM    activity in the database and how it is performaing.  When coupled 
REM    with the information generated in the script from:  "TFTS:  
REM    DATABASE SUMMARY REPORT", this script will assist in providing  
REM    a broad picture about a database. 
REM 
REM The report is formatted for landscape printing. 
REM 
REM ------------------------------------------------------------------------- 
REM EXAMPLE: 
REM    Too large to fit here. 
REM ------------------------------------------------------------------------- 
REM DISCLAIMER: 
...
column "Consistent Gets" format 999,999,999,999 
column "DB Block Gets" format 999,999,999,999 
...
TTitle left "***   Database:  "dbname", Current User Info (As of:  " xdate " )    ***" skip 2 
...
TTitle left "***   Database:  "dbname", Current Sessions (As of:  " xdate " )    ***" skip 2 

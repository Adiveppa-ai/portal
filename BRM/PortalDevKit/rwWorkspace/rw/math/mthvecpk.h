 ...
 *
 * $Id: //spro/rel2016.1/rw/math/mthvecpk.h#1 $
 *
 ...
 *
 * \brief
 * Allows selected elements to be addressed in a vector, without creating a
 * new view.
 *
 * The RWMathVecPick class allows selected elements to be addressed. Unlike
 * subscripting or slicing, picking does not create a new view.
 *
 * \example
 * \code
 * #include <iostream>
...
public:
    ...
    /**
     * Returns a reference to the value in the associated RWMathVec stored
     * at the index indicated by the \a i <sup>th</sup> element of the
     * RWMathVecPick.
     */

#ifndef __rw_itc_RWTPCValStackPrioritized_h__
#define __rw_itc_RWTPCValStackPrioritized_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/itc/RWTPCValStackPrioritized.h#1 $
 *
...
#  define RWPCValStackPrioritized RWTPCValStackPrioritized
#endif
 ...
 * cooperating threads.
 *
 * RWTPCValStackPrioritized is a last-in-first-out (LIFO) stack that
 ...
 * priority value is used during write operations to determine a value's
 * insertion point within the stack, such that the set of unread values will
 * be retrieved in priority order when they are eventually read from the
 * stack. A new value is retrieved before any previously inserted values of
 * the same priority.
 *
 * \example
 ...
 */
template <class Type>
class RWTPCValStackPrioritized :
    public RWTPCValBufferBasePrioritized<Type, RWTPriorityDecorator<Type> >
{
public:
    /**
     * Constructs a value-based, prioritized, producer-consumer stack
     * instance.
     *
...
#  include <rw/itc/RWTPCValStackPrioritized.cc>
#endif

#endif // __rw_itc_RWTPCValStackPrioritized_h__

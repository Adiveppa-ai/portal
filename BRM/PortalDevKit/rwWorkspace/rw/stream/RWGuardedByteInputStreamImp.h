#ifndef rw_stream_RWGuardedByteInputStreamImp_h_
#define rw_stream_RWGuardedByteInputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWGuardedByteInputStreamImp.h#1 $
 *
 ...
 *
 * \headerfileloc{#include <rw/stream/RWGuardedByteInputStreamImp.h>}
 *
 * The typedef #RWGuardedByteInputStreamImp implements a simple binary guard
 ...
 * synchronization mechanism, the input stream guard class has no effect.
 ...
 *
 * A \ref rwGuard(RWByteInputStream&) "rwGuard()" manipulator creates a
 ...
 * synchronized stream, the \ref rwGuard(RWByteInputStream&) "rwGuard()"
 ...
 * \endexample
 */
RWByteInputStream RW_STREAM_SYMBOLIC rwGuard(RWByteInputStream& stream);

#endif // rw_stream_RWGuardedByteInputStreamImp_h_

...
/////////////////////////////////////////////////////////////////////////
  ...
  RapAuditControlInfo:                                               
      ...
      returnSummaryList_RapAuditControlInfo     
  ...
  ReturnSummary:                                               
      RAP_0103.ReturnSummary                                 
      {                                                                   
        __onBlockStart("RAP_0103.ReturnSummary", false);   
        //logStdout("Parsed Sequence ReturnSummary\n");              
      }                                                                   
      fileSequenceNumber_ReturnSummary     
      severeReturnValue_ReturnSummary     
      ASN1.BlockEnd                                                   
      {                                                            
        __onBlockEnd("RAP_0103.ReturnSummary");     
        //logStdout("ReturnSummary Sequence END.\n");         
      }                                                            
    ;                                                              
  ...
  severeReturnValue_ReturnSummary:                                                       
      {                                                                                 
        currBlock = "severeReturnValue";                                                   
        //logStdout("currContext= " + currContext + "\n");                           
      }                                                                                 
      SevereReturnValue_opt                                                       
    ;                                                                                   
                                                                                        
                                                                                        
  ReturnSummaryList_opt:                                                                
      RAP_0103.ReturnSummaryList                                               
      {                                                                                 
        __onBlockStart("RAP_0103.ReturnSummaryList", true);                  
        //logStdout("Parsed List ReturnSummaryList\n");                                
      }                                                                                 
      ReturnSummaryList                                                                 
      ASN1.BlockEnd                                                                        
      {                                                                                 
        __onBlockEnd("RAP_0103.ReturnSummaryList");                          
        //logStdout("ReturnSummaryList List END.\n");                                  
      }                                                                                 
    |                                                                                   
    ;                                                                                   
  ...
  ReturnSummaryList:                                                                    
      ReturnSummaryList                                                                 
      ReturnSummary_ReturnSummaryList                                                    
    |                                                                                   
    ;                                                                                   
                                                                                        
  ReturnSummary_ReturnSummaryList:                                                       
      {                                                                                 
        currBlock = "ReturnSummary";                                                   
        //logStdout("currContext= " + currContext + "\n");                           
      }                                                                                 
      ReturnSummary                                                           
    ;                                                                                   
  ...
  SevereReturnValue:                                                             
      RAP_0103.SevereReturnValue                                        
      {                                                                          
        __onField("RAP_0103.SevereReturnValue.SevereReturnValue");    
        //logStdout("Parsed Leaf SevereReturnValue\n");                         
      }                                                                          
    ;                                                                            

 ...
 * also declared here.
 *
 * $Id: //spro/rel2016.1/rw/dataview.h#1 $
 *
 ...
 *
 * \brief
 * Base class for all classes that provide a view into a contiguous block of
 * memory.
 *
 * RWDataView is a base class for all classes that are a view into a

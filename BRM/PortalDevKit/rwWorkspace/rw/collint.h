 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/collint.h#1 $
 *
 **********************************************************************
 *
...
public:
    ...
    /**
     * Returns the difference between self and the RWCollectableInt pointed
     * to by \a c.
     */
    virtual int compareTo(const RWCollectable* c) const;

    /**
     * Returns the value of RWCollectableInt as an \c unsigned, to be used
     * as a hash value.
     */
    virtual unsigned hash() const;

    /**
     * Returns \c true if self has the same value as the RWCollectableInt at
     * address \a c.
     */

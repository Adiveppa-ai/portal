...
sub configure_JobExecutor {
   ...
   $Cmd = &FixSlashes($header."\n" 
                       .$Pref."/home/pin/opt/portal/Thirdparty/jdk1.8.0_401/bin/java -cp \"$PIN_HOME/jars/pin_job_executor.jar".$Sep
...
sub configure_PriceList {
   ...
   $Cmd = &FixSlashes($header."\n" 
		       .$Pref."/home/pin/opt/portal/Thirdparty/jdk1.8.0_401/bin/java -cp \"$PIN_HOME/jars/loadpricelist.jar".$Sep
		       ."$PIN_HOME/jars/pcm.jar".$Sep
		       ."$PIN_HOME/jars/pcmext.jar".$Sep
                       ."$PIN_HOME/jars/oraclepki.jar".$Sep
                       ."$PIN_HOME/jars/osdt_cert.jar".$Sep
...
sub configure_DeviceMgmt {
   ...
   $Cmd = &FixSlashes( $Pref."/home/pin/opt/portal/Thirdparty/jdk1.8.0_401/bin/java -cp \"$PIN_HOME/jars/pcm.jar".$Sep
		       ."$PIN_HOME/jars/pcmext.jar".$Sep
...
sub configure_Sepa {
   ...
   $Cmd = &FixSlashes($header."\n"
                       .$Pref."/home/pin/opt/portal/Thirdparty/jdk1.8.0_401/bin/java -cp \"$PIN_HOME/jars/sepa.jar".$Sep
                       ."$PIN_HOME/jars/pcm.jar".$Sep
                       ."$PIN_HOME/jars/pcmext.jar".$Sep
                       ."$PIN_HOME/jars/oraclepki.jar".$Sep
                       ."$PIN_HOME/jars/osdt_cert.jar".$Sep

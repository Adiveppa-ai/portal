 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stringid.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWStringID is an identifier for RWCollectable instances. It is
 * derived from RWCString, and may be manipulated by any of the const
 * RWCString methods. The non-const methods have been hidden to prevent the
 * disaster that could occur if the RWStringID of a class changed at run
 * time.
 *
 ...
 * automatically generate an RWStringID that is the same sequence of
 * characters as the name of the class; for example, class MyColl : public
 * RWCollectable would get the automatic RWStringID "MyColl".
 *
 * \example
 * You specify a class with a fixed #RWClassID and generated RWStringID by
 * using the macro RW_DEFINE_COLLECTABLE_CLASS_BY_ID as follows:
 *
 * \code
...
public:
    ...
    /**
     * Copy constructor. Sets the value of the string ID to the value of
     * \a sid.
     */
    ...
    /**
     * Move Constructor. The created string ID takes ownership of the data
     * owned by \a s.
     *
     * \conditional
     * This method is available only on platforms with rvalue reference
     * support.
     */
    ...
    /**
     * Assignment operator. Copies the data from string ID \a sid. Returns a
     * reference to self.
     */
    ...
    /**
     * Move assignment. Self takes ownership of the data owned by \a sid.
     *
     * \conditional
     * This method is available only on platforms with rvalue reference
     * support.
    ...
    /**
     * Returns the \a t<sup>th</sup> byte in self. The index \a t must be
    ...
    /**
     * \copydoc RWCString::operator()(size_t) const
     */
    char  operator()(size_t t) const
    {
        return RWCString::operator()(t);
    ...
    /**
     * \copydoc RWCString::binaryStoreSize() const
     */
    ...
    /**
     * \copydoc RWCString::isAscii() const
     */
    bool     isAscii() const
    {
    ...
    /**
     * \copydoc RWCString::isNull() const
     */
    bool     isNull() const
    {
    ...
    /**
     * \copydoc RWCString::length() const
     */
    size_t        length() const
    {
    ...
    /**
     * \copydoc RWCString::capacity() const
     */
    ...
    /**
     * \copydoc RWCString::capacity(size_t)
     */
...
#ifndef RW_NO_LOCALE
    /**
     * \copydoc RWCString::collate(const char*) const
     */
    ...
    /**
     * \copydoc RWCString::collate(const RWCString&) const
     */
    ...
    /**
     * \copydoc RWCString::compareTo(const char*, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::compareTo(const RWCString&, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::contains(const char*, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::contains(const RWCString&, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::first(char) const
     */
    ...
    /**
     * \copydoc RWCString::first(const char*) const
     */
    ...
    /**
     * \copydoc RWCString::firstOf(char, size_t) const
     */
    ...
    /**
     * \copydoc RWCString::firstOf(const char*, size_t) const
     */
    ...
    /**
     * \copydoc RWCString::index(const char*, size_t i, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::index(const RWCString&, size_t i, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::index(const char*, size_t, size_t, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::index(const RWCString&, size_t, size_t, caseCompare) const
     */
    ...
    /**
     * \copydoc RWCString::index(const RWCRExpr&, size_t) const
     */
    RW_DEPRECATE_FUNC("")
    ...
    /**
     * \copydoc RWCString::index(const RWCRExpr&, size_t*, size_t) const
     */
    RW_DEPRECATE_FUNC("")
    ...
    /**
     * \copydoc RWCString::index(const char*, size_t*, size_t) const
     */
    RW_DEPRECATE_FUNC("")
    ...
    /**
     * \copydoc RWCString::index(const RWCRegexp&, size_t) const
     */
    RW_DEPRECATE_FUNC("")
    ...
    /**
     * \copydoc RWCString::index(const RWCRegexp&, size_t*, size_t) const
     */
    RW_DEPRECATE_FUNC("")
    ...
    /**
     * \copydoc RWCString::last(char) const
     */
    ...
    /**
     * \copydoc RWCString::last(char, size_t) const
     */
    ...
    /**
     * \copydoc RWCString::lastOf(char, size_t) const
     */
     ...
     * \relates RWStringID
     *
     * Logical equality and inequality. Case sensitivity is <em>exact</em>.
     * This function is incompatible with \c const \c char* strings with
     * embedded nulls. This function may be incompatible with \c const
     * \c char* MBCS strings.
     */
     ...
     * \relates RWStringID
     *
     * Comparisons are done lexicographically, byte by byte. Case
     * sensitivity is <em>exact</em>. Use member RWStringID::collate() for
     * locale sensitivity. <em>This function is incompatible with</em>
     * <tt>const char*</tt> <em>strings with embedded nulls. This function
     * may be incompatible with</em> <tt>const char*</tt> <em>MBCS
     * strings.</em>
     */
    friend  bool operator>(const RWStringID& lhs, const RWStringID& rhs)
    {
     ...
     * \relates RWStringID
     *
     * Restores a string into \a sid from a virtual stream, replacing the
     * previous contents of \a sid. If the virtual stream produces an error
     * on extraction, the operator returns the original string contents
     * unmodified. Be sure to check the virtual stream to determine if an
     ...
     * \relates RWStringID
     *
     * Restores a string into \a sid from an RWFile, replacing the previous
     * contents of \a sid. If the file produce an error on extraction, the
     ...
     * \relates RWStringID
     *
     * Calls RWCString::readToken(std::istream&). That is, a token is read
     * from the input stream \a is. <em>This function is incompatible with
     * MBCS strings.</em>
     */

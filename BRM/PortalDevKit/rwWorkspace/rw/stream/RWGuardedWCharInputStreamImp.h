#ifndef rw_stream_RWGuardedWCharInputStreamImp_h_
#define rw_stream_RWGuardedWCharInputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWGuardedWCharInputStreamImp.h#1 $
 *
 ...
 *
 * \headerfileloc{#include <rw/stream/RWGuardedWCharInputStreamImp.h>}
 *
 * The typedef #RWGuardedWCharInputStreamImp implements a simple wide
 ...
 *
 * A \ref rwGuard(RWWCharInputStream&) "rwGuard()" manipulator creates a
 ...
 * synchronized stream, the \ref rwGuard(RWWCharInputStream&) "rwGuard()"
 ...
 * \endcode
 */
RWWCharInputStream RW_STREAM_SYMBOLIC rwGuard(RWWCharInputStream& stream);

#endif // rw_stream_RWGuardedWCharInputStreamImp_h_

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/colltime.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * RWCollectableTime and RWTime are deprecated and are no longer supported.
 * They may be removed from future releases. Please use
 * RWCollectableDateTime and RWDateTime.
 *
 * \brief
 * Deprecated. Inherits classes RWTime and RWCollectable
 *
 * Inherits classes RWTime and RWCollectable. This class is useful when
 * times are used as keys in the "dictionary" collection classes, or if
 * times are stored and retrieved as RWCollectable instances.
 *
...
public:
    ...
    /**
     * Returns the results of calling operator==() for the base class RWTime

#ifndef rw_stream_RWSynchronizedByteInputStreamImp_h_
#define rw_stream_RWSynchronizedByteInputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWSynchronizedByteInputStreamImp.h#1 $
 *
...
extern template class RW_STREAM_GLOBAL RWTInputStreamLockImp<RWByteInputStream, RWFilteredByteInputStreamImp>;
#  else
template class RW_STREAM_GLOBAL RWTInputStreamLockImp<RWByteInputStream, RWFilteredByteInputStreamImp>;
#  endif
#endif
 ...
 *
 * \brief
 * Implementation of a simple lock stream that is used with a binary input
 * stream.
 *
 * Class RWSynchronizedByteInputStreamImp implements a simple lock stream
 * that is used with binary input stream. The stream locks its internal
 ...
 */
class RW_STREAM_GLOBAL RWSynchronizedByteInputStreamImp : public RWTInputStreamLockImp<RWByteInputStream, RWFilteredByteInputStreamImp>
{

public:

    /**
     * Constructs an RWSynchronizedByteInputStreamImp instance that uses
     * \a sourceStream as the source of bytes, and returns a handle to it.
    ...
    {
        return RWByteInputStream(new RWSynchronizedByteInputStreamImp(sourceStream));
    }
...
#endif // rw_stream_RWSynchronizedByteInputStreamImp_h_

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/compiler.h#1 $
 *
 **********************************************************************
 *
...
#  if !defined(RW_SECURE_CHECK)
#    define RW_SUPPRESS_SECURE_WARNINGS \
            __pragma(warning(push)) \
            __pragma(warning(disable:4996))

#    define RW_RESTORE_SECURE_WARNINGS \
            __pragma(warning(pop))
#  endif
#endif  //_MSC_VER
...
#if defined(__HP_aCC) && (__HP_aCC <= 62802)

#  if (__HP_aCC >= 62800 && __HP_aCC <= 62801)
...
//////////////////////////////////////////////////////////
// Different C++ Standard Library Implementation Issues
//////////////////////////////////////////////////////////
...
#if !defined(RW_SUPPRESS_SECURE_WARNINGS)
#  define RW_SUPPRESS_SECURE_WARNINGS
#endif

#if !defined(RW_RESTORE_SECURE_WARNINGS)
#  define RW_RESTORE_SECURE_WARNINGS
#endif

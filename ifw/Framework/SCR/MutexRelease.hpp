#ifndef SCR_MUTEXRELEASE_HPP
#define SCR_MUTEXRELEASE_HPP
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the iScript function node for mutexRelease.
//
// Open Points:
//   <open points>
//
...
/** <b><tt>MutexRelease</tt></b>
 */
class MutexRelease : public BoolNode
{
  public:
    /**@name MutexRelease constructors and destructor */
    //@{

    /** Destructor
     */
    virtual ~MutexRelease();

    //@}


    /**@name MutexRelease public methods */
    //@{
    ...
    /** Create a mutexRelease() function node
  ...
  protected:
     ...
     */
    MutexRelease( MainExtension* mainExtension,

#ifndef __RWDB_OCIBUFFERFACTORY_H__
#define __RWDB_OCIBUFFERFACTORY_H__

/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/db/ocisrc/rwdbocibufferfactory.h#1 $
 *
 ...
 **************************************************************************
 *
 * Oracle Access Module specialized RWDBBufferFactory
 *
 **************************************************************************/
...
const ub2 RWDB_MAX_UB2 = 65535;

//////////////////////////////////////////////////////////////////////////
//
// RWDBOCIBufferFactory
//
// This class is used to produce buffers based on data criteria.
//
//////////////////////////////////////////////////////////////////////////
class RWDBOCIBufferFactory
    : public RWDBGenericBufferFactory
{
public:
    virtual ~RWDBOCIBufferFactory() {}
                                     ...
                                     size_t storageLength) const
    {
        switch (type) {
            ...
            case RWDBValue::Float:
                return new RWDBBuffer(RWDBCType(RWDB_TYPE_FLOAT,
                                                sizeof(float)),
                                      RWDBCTypeStockMemoryManager<float>::allocator,
                                      RWDBCTypeStockMemoryManager<float>::deallocator,
                                      rows);
            ...
            case RWDBValue::LongLong:
                return new RWDBBuffer(RWDBCType(RWDB_TYPE_LONGLONG,
                                                sizeof(long long)),

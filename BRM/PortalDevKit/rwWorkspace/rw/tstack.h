 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tstack.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWTStack maintains a stack of values. Not only can the type of
 * object inserted onto the stack be parameterized, but also the
 * implementation of the stack.
 *
 * Parameter \c T represents the type of object in the stack, either a class
 * or built-in type. Class \c T must have:
 *
 ...
 *
 * Useful choices for \c C are RWTValDlist or RWTValOrderedVector. Singly-
 * linked list classes, such as RWTValSlist, can also be used, but tend to
 * be less efficient at removing the last item.
 *
 * \synopsis
 * #include <rw/tstack.h>
 * RWTStack<T, C> stack;
...
public:
    ...
    /**
     * Returns the result of calling <tt>C::removeLast()</tt> on the

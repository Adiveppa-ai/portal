 ...
 * array.h
 *
 * $Id: //spro/rel2016.1/rw/array.h#1 $
 *
 ...
 *
 * \brief
 * An \c n-dimensional index class for traversing arrays of arbitrary
 * dimension.
 *
 * Class RWMultiIndex is an \c n-dimensional index class. It is a tool for
 * traversing arrays of arbitrary dimension. As shown in the <b>Example</b>
 * below, you can use RWMultiIndex to help you write subroutines that
 * operate on arrays of arbitrary dimension. Using automatic type
 * conversion, you can then call these subroutines with vectors, matrices,
 * or arrays. For instance, you can use the <b>Example</b> subroutine as
 * follows:
 *
 * \code
 * RWMathVec<int>  v;

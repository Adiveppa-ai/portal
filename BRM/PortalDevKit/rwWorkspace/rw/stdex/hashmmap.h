...
/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stdex/hashmmap.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * Maintains a collection of mappings between two types \c K and \c V,
 * implemented as a hash table of \b std::pair<const K,V> instances where
 * multiple instances of the same \c K are allowed.
 *
 ...
 * the ANSI <em>associative container</em> specification, rw_hashmultimap
...
public:
    ...
    /**
     * \deprecated
     * As of SourcePro 12.5, use \ref rw_hashmultimap::hasher "hasher"
     * instead.
     *
     * A type representing the hash function.
     */

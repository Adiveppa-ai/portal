...
#define PLI_InputManagerInterface_HPP
//==============================================================================
//
...
// Responsible: bt
//
// $RCSfile: InputManagerInterface.hpp,v $
// $Revision: 1.4 $
// $Author: bt $
...
//
//------------------------------------------------------------------------------
// $Log: InputManagerInterface.hpp,v $
...
namespace PLI
{
/** <tt><b>class InputStreamInterface</b></tt><br>
    This class is the input stream plugin (module) interface.

    <p><table BORDER CELLSPACING=0 CELLPADDING=2 NOSAVE >
    <tr>
    <td><font size=-1>$RCSfile: InputManagerInterface.hpp,v $</font></td>
...
*/
class InputManagerInterface : public StdInterface<STR::InStreamManager>
{
  public:
    ...
    //@{
      ...
      InputManagerInterface(const BAS::String& objectName);
  ...
  private:
    ...
    // They are private to prevent unintentionally use.
      ...
      InputManagerInterface(InputManagerInterface& right);

      const InputManagerInterface& operator=(InputManagerInterface& right);
};
}
#endif // InputManagerInterface_HPP

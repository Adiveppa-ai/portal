 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tvsrtvec.h#1 $
 *
 **********************************************************************
 *
 ...
 * \sa
 * \parblock
 * RWTValSortedDlist is an alternative always-sorted collection.
...
#  endif
    ...
    /**
     * Assignment operator. Copies and sorts elements from the data in
     * \a rhs.
     */
    RWTValSortedVector&
 ...
 *
 * Class RWTValSortedVector provides a generic always-sorted vector for
 * non-boolean types.
 *
...
public:
    ...
    /**
     * Constructs a vector by copying and sorting elements from the array of
     * <tt>T</tt>s pointed to by \a first, up to, but not including, the
     * element pointed to by \a last.
     */

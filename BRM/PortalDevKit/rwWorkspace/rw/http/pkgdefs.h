#ifndef __rw_http_pkgdefs_h__
#define __rw_http_pkgdefs_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/http/pkgdefs.h#1 $
 *
...
#include <rw/config/rwconfig_http.h>
...
//////////////////////////////////////////////////////////////////////////////
#if defined(_RWBUILD_http)
#  define RW_HTTP_BUILD
#endif

// Compatibility definitions
#if defined(_WIN32) && defined(RW_HTTP_DLL)
#  if defined(_RWBUILD_http)
#    define _RWHTTPBUILDDLL
#  endif // _RWBUILD_http
#endif // _WIN32 && RW_HTTP_DLL
...
#  if defined(RW_HTTP_BUILD)
#    define RW_HTTP_GLOBAL                      RW_COMPILER_GLOBAL_EXPORT
#    define RW_HTTP_SYMBOLIC                    RW_COMPILER_SYMBOLIC_EXPORT
#  else
#    define RW_HTTP_GLOBAL                      RW_COMPILER_GLOBAL_IMPORT
#    define RW_HTTP_SYMBOLIC                    RW_COMPILER_GLOBAL_IMPORT
#  endif
#else
#  define RW_HTTP_GLOBAL
#  define RW_HTTP_SYMBOLIC
#endif
...
#define RW_HTTP_IDENT \
  static const char rw_http_ident[] = "\"@(#)\trw/http:" __FILE__ " " __DATE__ " " __TIME__ "\""; \
  inline void rw_use_http_ident(void) { RW_UNUSED(rw_http_ident); }

 ...
 ***************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/randmcg59.h#1 $
 *
 ...
 * <tt>[0, 1]</tt>.
 *
 * Class RWRandGenMCG59 generates random numbers uniformly distributed over
 ...
 * generators derived from abstract base class RWTRand. RWRandGenMCG59 is a
 ...
 * \f]
 *
 * Unlike class RWRandGenerator, each instance of RWRandGenMCG59 contains
 * and maintains its own, independent state. This can make it easier to use
 * in some situations. The "internal state" of an instance of RWRandGenMCG59
 * consists of only a seed.
 *
 * \synopsis

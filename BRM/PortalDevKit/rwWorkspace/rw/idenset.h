 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/idenset.h#1 $
 *
 **********************************************************************
 *
 ...
 * found by requiring that they be \e identical (i.e., have the same
 * address) as the key, rather than being equal (i.e., test \c true for
 * \ref RWCollectable::isEqual() "isEqual()").
 *
 * <em>The iterator for this class is</em> RWSetIterator.
 *
 * \synopsis
...
public:
    ...
    /**
     * Constructs an empty identity set with RWCollection::DEFAULT_CAPACITY
     * hashing buckets.
     */
    RWIdentitySet();
    ...
    /**
     * Copy constructor. Makes a shallow copy of the collection \a s.
     */
    RWIdentitySet(const RWIdentitySet& s) : RWSet(s) { }

#if !defined(RW_NO_RVALUE_REFERENCES)
    /**
     * Move constructor. The constructed RWIdentitySet takes ownership of
     * the data owned by \a s.
     *
     * \conditional
    ...
    /**
     * Assignment operator. Makes a shallow copy of the collection \a s.
     */

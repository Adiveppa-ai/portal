...
OPATCH_COMMON_API_CLASSPATH="${MODULES_DIR}/features/oracle.glcm.opatch.common.api.classpath.jar:${ORACLE_COMMON_MODULES_DIR}/internal/features/lib_jaxb_2.3.5.jar"

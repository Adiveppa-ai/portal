 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/regexresult.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWTRegexResult is a class template that encapsulates the result of
 * a RWTRegex::matchAt() or RWTRegex::search() operation executed on an
 * instance of RWTRegex.
 *
 * \synopsis

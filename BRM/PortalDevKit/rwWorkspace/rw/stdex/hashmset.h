...
/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stdex/hashmset.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * Maintains a collection of some type \c T, in which there may be many
 * equivalent instances of \c T.
 *
 ...
 * collection. As with all classes that meet the ANSI <em>associative
 * container</em> specification, rw_hashmultiset provides for iterators that
...
public:
    ...
    /**
     * \deprecated
     * As of SourcePro 12.5, use \ref rw_hashset::hasher "hasher" instead.
     *
     * A type representing the hash function.
     */
    ...
    /**
     * Constructs an rw_hashmultiset containing a copy of the elements in
     * the range [\a first, \a last). The rw_hashmultiset instance has
     * \a cap buckets, uses \a h as its hash function object, and \a eq as
     * the equality function object.
     *

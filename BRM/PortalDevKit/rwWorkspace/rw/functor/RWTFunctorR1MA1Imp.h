#ifndef __rw_functor_RWTFunctorR1MA1Imp_h__
#define __rw_functor_RWTFunctorR1MA1Imp_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/functor/RWTFunctorR1MA1Imp.h#1 $
 *
...
#  define RWFunctorR1MA1Imp RWTFunctorR1MA1Imp
#  define rwMakeFunctorR1MA1 rwtMakeFunctorR1MA1
...
//--        rwtMakeFunctorR1((int(*)(short))0, f, &Foo::bar, 1234);
//--
...
class RWTFunctorR1MA1Imp : public RWTFunctorR1Imp<SR, S1>
{

public:

    // Destructor
    ~RWTFunctorR1MA1Imp(void);
    ...
    //-- Creates a new RWTFunctorR1MA1Imp and returns an appropriate handle.
    static RWTFunctorR1<SR, S1> make(Callee& callee, CalleeSignature function, A1 a1);

    // Invoke the encapsulated function, passing in the callee argument.
    virtual SR run(S1 s1) const;

protected:

    // Constructor, only for internal use.
    RWTFunctorR1MA1Imp(Callee& callee, CalleeSignature function, A1 a1);

private:

    RWTFunctorR1MA1Imp(const RWTFunctorR1MA1Imp& second);

    RWTFunctorR1MA1Imp&
    operator=(const RWTFunctorR1MA1Imp& second);
...
//-- A macro for ease of use in creating new 'RWTFunctorR1MA1Imp' bodies.
 ...
 *
 * Macro to create an RWTFunctorR1 set to call
 * <tt>callee.function(s,a1)</tt>. \a function must have signature
 * <tt>DR (Caller::*)(D1,A1)</tt>
 */
RW_DEPRECATE_MACRO("rwtMakeFunctorR1MA1", "Use rwBind() instead")
#define rwtMakeFunctorR1MA1(SR,S1,Callee,callee,DR,function,D1,A1,a1) \
   RWTFunctorR1MA1Imp<SR,S1,Callee,DR,D1,A1 >::make(callee,function,a1)

template <class SR, class S1, class Callee, class DR, class D1, class A1>
inline RWTFunctorR1<SR, S1>
RWTFunctorR1MA1Imp<SR, S1, Callee, DR, D1, A1>::make(Callee& callee, CalleeSignature function, A1 a1)
{
    return new RWTFunctorR1MA1Imp<SR, S1, Callee, DR, D1, A1>(callee, function, a1);
}

template <class SR, class S1, class Callee, class DR, class D1, class A1>
inline
RWTFunctorR1MA1Imp<SR, S1, Callee, DR, D1, A1>::RWTFunctorR1MA1Imp(Callee& callee,
...
template <class SR, class S1, class Callee, class DR, class D1, class A1>
inline
RWTFunctorR1MA1Imp<SR, S1, Callee, DR, D1, A1>::~RWTFunctorR1MA1Imp(void)
{
}

#if defined(RW_NO_IMPLICIT_INCLUSION)
#  include <rw/functor/RWTFunctorR1MA1Imp.cc>
#endif

RW_RESTORE_DEPRECATED_WARNINGS
#endif

#endif // __rw_functor_RWTFunctorR1MA1Imp_h__

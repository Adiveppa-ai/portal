...
$IDS_AQ_SYNC_QUEUE_CREATION = "\nCreating AQ SYNC Queue in the Queue database\n";
$IDS_AQ_SYNC_QUEUE_CREATION_FAILED = "\n*** Error: AQ SYNC Queue creation failed in the Queue Database\n";
$IDS_AQ_SYNC_QUEUE_CREATION_SUCCESS = "\nAQ SYNC Queue successfully created in the Queue Database\n";
...
$IDS_DISTRIBUTION_LOADING = "\nLoading config_dist.conf file \n";
$IDS_DISTRIBUTION_FAILED = "\nLoad config_dist.conf file failed\n";
$IDS_DISTRIBUTION_SUCCESS = "\nLoad config_dist.conf successful\n";

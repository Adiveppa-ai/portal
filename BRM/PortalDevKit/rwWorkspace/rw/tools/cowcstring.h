 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/cowcstring.h#1 $
 *
 **********************************************************************
 *
 ...
 * is defined.
 *
 * RWCopyOnWriteCSubString should be directly used only with instances of
 * class RWCopyOnWriteCString. RWCSubString should be used with instances of
 * class RWCString.
 *
 * \sa
 ...
 * of class RWCopyOnWriteCString. RWCConstSubString should be used with
 * instances of class RWCString.
 *
 * \sa
...
RWCopyOnWriteCSubString::toLower()
{
    if (!isNull()) {
        str_->cow();
        char* p = const_cast<char*>(str_->data() + begin_);
        size_t N = extent_;
        while (N--) {
            *p = char(tolower(static_cast<unsigned char>(*p)));
            p++;

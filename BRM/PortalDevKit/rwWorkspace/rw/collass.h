 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/collass.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * Associates a key with a value in the Essential Tools Module "dictionary"
 * collection classes.
 *
 * RWCollectableAssociation inherits class RWCollectable. Used internally to
 * associate a key with a value in the Essential Tools Module "dictionary"
 * collection classes. Comparison and equality testing are forwarded to the
 * key part of the association.
 *
 * \synopsis
 ...
 * their content is dealt with as an RWCollectable, such as when
 * operator+=() or asBag() is used, the RWCollectableAssociation is exposed.
 *

...
my %fldt_map = (
	...
	PIN_FLDT_TIME		=> 0x0F000000,
	PIN_FLDT_TEXTBUF	=> 0x10000000,
	PIN_FLDT_INT64		=> 0x11000000,
);
...
my %PINCLASS = (
	...
	"PIN_FLDT_TIME",           "TimeField",
	"PIN_FLDT_TEXTBUF",        "TextBufField",
	"PIN_FLDT_INT64",          "Int64Field",
);

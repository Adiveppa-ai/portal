#=======================================================================
#  $Id: pin_cnf_dm_db.pl /cgbubrm_mainbrm.portalbase/1 2017/07/25 13:31:58 mkothari Exp $
# 
...
#========================================================================
END
	,"db_sm_pw", "- decrypt md5| \"Abracadabra dabracaabrA\""

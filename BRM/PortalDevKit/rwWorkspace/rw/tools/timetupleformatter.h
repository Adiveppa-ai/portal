/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/timetupleformatter.h#1 $
 *
...
#ifndef RW_TOOLS_TIMETUPLE_FORMATTER_H
#define RW_TOOLS_TIMETUPLE_FORMATTER_H
 ...
 *
 * \brief
 * Formats a RWTimeTuple based on a user-defined format.
 *
 * RWTimeTupleFormatter uses a \b strftime()-based format specification,
 ...
 * be used with RWTimeTupleFormatter. In all cases, the behavior of the format
 * function is unspecified when the input tuple is not normalized.
 *
 * <table>
 * <tr>
 ...
 *
 */
class RW_TOOLS_GLOBAL RWTimeTupleFormatter
{
public:
    /**
     * Constructs an RWTimeTupleFormatter with the format specification \a
     * format.
     */
    ...
    /**
     * \copydoc RWTimeTupleFormatter(const RWCString&)
     *
     * \conditional
     ...
     */
    RWTimeTupleFormatter& operator=(const RWTimeTupleFormatter& rhs);
     ...
     * support.
     */
    RWTimeTupleFormatter& operator=(RWTimeTupleFormatter&& rhs);
#endif

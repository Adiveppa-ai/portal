#ifndef __rw_functor_map_RWTFunctorMap2Imp_h__
#define __rw_functor_map_RWTFunctorMap2Imp_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/functor/map/RWTFunctorMap2Imp.h#1 $
 *
...
class RWTFunctorMap2Imp : public RWTFunctor2Imp<Key, S1>
{
...
public:
    ...
    friend class RWTFunctorMap2<Key, S1>;

    // Destructors
    ~RWTFunctorMap2Imp(void);
    ...
    // default functor has been set, calls the default.
    // If there is no default, and no matching key, throws a
...
private:
    ...
    RWTFunctorMap2Imp(const RWTFunctorMap2Imp& second);

    RWTFunctorMap2Imp&
    operator=(const RWTFunctorMap2Imp& second);

protected:

    // Constructor is private, forcing users to create maps via the
    // handle class 'RWTFunctorMap2'.
    RWTFunctorMap2Imp(hash_function hf, size_t size);

    // The actual map, which stores the associations between
    // keys and functors.
    RWTValHashDictionary<Key, RWTFunctor1<S1>, RWTHasher<Key> > map_;

    // The default functor.  If set, this is used whenever an invalid
    // key is passed.
    RWTFunctor1<S1> defaultFunctor;

};


#if defined(RW_NO_IMPLICIT_INCLUSION)
#  include <rw/functor/map/RWTFunctorMap2Imp.cc>
#endif

RW_RESTORE_DEPRECATED_WARNINGS
#endif

#endif // __rw_functor_map_RWTFunctorMap2Imp_h__

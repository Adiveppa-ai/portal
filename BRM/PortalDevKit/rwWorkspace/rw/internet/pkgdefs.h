#ifndef __rw_internet_pkgdefs_h__
#define __rw_internet_pkgdefs_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/internet/pkgdefs.h#1 $
 *
...
//////////////////////////////////////////////////////////////////////////////
#if defined(_RWBUILD_internet)
#  define RW_INTERNET_BUILD
#endif

// Compatibility definitions
#if defined(_WIN32) && defined(RW_INTERNET_DLL)
#  if defined(_RWBUILD_internet)
#    define _RWINTERNETBUILDDLL
#  endif // _RWBUILD_internet
#endif // _WIN32 && RW_INTERNET_DLL
...
#  if defined(RW_INTERNET_BUILD)
#    define RW_INTERNET_GLOBAL                      RW_COMPILER_GLOBAL_EXPORT
#    define RW_INTERNET_SYMBOLIC                    RW_COMPILER_SYMBOLIC_EXPORT
#  else
#    define RW_INTERNET_GLOBAL                      RW_COMPILER_GLOBAL_IMPORT
#    define RW_INTERNET_SYMBOLIC                    RW_COMPILER_GLOBAL_IMPORT
#  endif
#else
#  define RW_INTERNET_GLOBAL
#  define RW_INTERNET_SYMBOLIC
#endif
...
#define RW_INTERNET_IDENT \
  static const char rw_internet_ident[] = "\"@(#)\trw/internet:" __FILE__ " " __DATE__ " " __TIME__ "\""; \
  inline void rw_use_internet_ident(void) { RW_UNUSED(rw_internet_ident); }
...
#endif // __rw_internet_pkgdefs_h__

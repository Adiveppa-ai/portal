#ifndef __rw_itc_RWTPCPtrStack_h__
#define __rw_itc_RWTPCPtrStack_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/itc/RWTPCPtrStack.h#1 $
 *
...
#  define RWPCPtrStack RWTPCPtrStack
#endif
 ...
 * synchronization semantics for exchanging pointer values between
 * cooperating threads.
 *
 * RWTPCPtrStack is a last-in-first-out (LIFO) stack that provides
 ...
 * (producers) are blocked while the stack is full. A buffer is considered
 ...
 */
template <class Type>
class RWTPCPtrStack : public RWTPCPtrBufferBase<Type>
{
public:
    /**
     ...
     * entries allowed to accumulate within the stack. Once the number of
     ...
     * zero is used to indicate that the stack has no size limit, except as
...
template <class Type>
inline
RWTPCPtrStack<Type>::RWTPCPtrStack(void)
{
}

template <class Type>
inline
RWTPCPtrStack<Type>::RWTPCPtrStack(size_t maxCapacity)
...
template <class Type>
inline
RWTPCPtrStack<Type>::RWTPCPtrStack(size_t maxCapacity, bool isOpen)
...
#  include <rw/itc/RWTPCPtrStack.cc>
#endif

#endif // __rw_itc_RWTPCPtrStack_h__

...
- cm fm_module \$\{PIN_HOME\}/lib/fm_publish_pol\$\{LIBRARYEXTENSION\} fm_publish_pol_config$FM_FUNCTION_SUFFIX - pin
END
    , "enable_preferences_enrichment_description", <<END
#========================================================================
# enable_preferences_enrichment
#
# Enables enrichment of business events with notification preferences.
#
# The value for this entry can be:
#
#    0 = (Default) Doesn't enrich the business events.
#    1 = Enriches the business events being published through the EAI framework.
#========================================================================
END
    , "enable_preferences_enrichment", "- fm_publish enable_preferences_enrichment 0"
    , "prefs_enabled_publisher_list_description", <<END
#========================================================================
# prefs_enabled_publisher_list
#
# List of publishers for which the enrichment of business events with
# notification preferences will be done.
#
# The value for this entry can be:
#
#    Commented/Not specified:    (Default) All publishers will be enabled.
#    0.0.9.6,0.0.9.9 : Enriches the business events only for publishers
#                      with db number specified. It will be a comma
#                      seperated list. In this example, it would be enabled
#                      for DM Kafka and DM IFWSync.
#========================================================================
END
    , "prefs_enabled_publisher_list", "#- fm_publish prefs_enabled_publisher_list 0.0.9.6"
    , "prefs_phone_no_location_description", <<END
#========================================================================
# prefs_phone_no_location
#
# Location of the subscriber phone number, which is to be put in as
# part of the notification enrichment.
#
# The value for this entry can be:
#
#    Commented/Not specified:    (Default) Will pickup up from
#                                /profile/subscriber_preferences.
#    -1 : Looks in /service.PIN_FLD_LOGIN
#     0  - 2^32: Looks in /service.PIN_FLD_ALIAS_LIST.PIN_FLD_NAME.
#                Uses the value specified as the array index.
#========================================================================
END
    , "prefs_phone_no_location", "#- fm_publish prefs_phone_no_location 0"
);

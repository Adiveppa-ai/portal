 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/bitref.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWBitRef is used as an l-value to the RWBitVec and
 * \ref RWTBitVec "RWTBitVec<N>" classes. RWBitRef instances should \e not

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/queuecol.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * A restricted interface to class RWSlistCollectables in order to implement
 ...
 * \b queue is a sequential list for which all insertions are made at one
 * end (the "tail"), and all removals are made at the other end (the
 * "head"). Hence, the ordering is determined externally by the ordering of
 * the insertions. Duplicates are allowed.
 *
 ...
 * \ref RWCollectable::isEqual() "isEqual()" (see class RWCollectable) to
 * find a match between a target and an item in the queue.
 *
...
public:
    ...
    /**
     * Returns \c __RWSLISTCOLLECTABLESQUEUE, i.e. a <em>class

#ifndef SCR_MUTEXDESTROY_HPP
#define SCR_MUTEXDESTROY_HPP
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the iScript function node for mutexDestroy.
//
// Open Points:
//   <open points>
//
...
/** <b><tt>MutexDestroy</tt></b>
 */
class MutexDestroy : public BoolNode
{
  public:
    /**@name MutexDestroy constructors and destructor */
    //@{

    /** Destructor
     */
    virtual ~MutexDestroy();

    //@}


    /**@name MutexDestroy public methods */
    //@{
    ...
    /** Create a mutexDestroy() function node
  ...
  protected:
     ...
     */
    MutexDestroy( MainExtension* mainExtension,

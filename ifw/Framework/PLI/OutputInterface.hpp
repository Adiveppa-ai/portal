...
#define PLI_OutputInterface_HPP
//==============================================================================
//
...
namespace PLI
{
/** <tt><b>class OutputInterface</b></tt><br>
    This class is the output plug in interface.

    <p><table BORDER CELLSPACING=0 CELLPADDING=2 NOSAVE >
    <tr>
    <td><font size=-1>$RCSfile: OutputInterface.hpp,v $</font></td>
...
*/
class OutputInterface : public StdInterface<PLG::OutputDevice>
{
  public:
    ...
    //@{
      ...
      OutputInterface(const BAS::String& objectName);
  ...
  private:
    ...
    // They are private to prevent unintentionally use.
      ...
      OutputInterface(OutputInterface& right);

      const OutputInterface& operator=(OutputInterface& right);
};
}
#endif // OutputInterface_HPP

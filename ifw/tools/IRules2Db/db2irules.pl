...
if ( ($#ARGV != 1) && ($#ARGV != 2) && ($#ARGV != 3) ) {
    print STDERR "usage: db2irules.pl [-d] [-u] <dbsn> <username> [<filepath>] [<RulesetName>]\n\n";
    ...
    print STDERR "Example: db2irules.pl dbi:Oracle:orcl scott .. \n";
    print STDERR "Example: db2irules.pl -u dbi:Oracle:orcl scott ./ TAP3_VAL\n";
    print STDERR "Example: db2irules.pl -d -u dbi:Oracle:orcl scott \n\n";
...
if ($DEBUG) {
    print "dbsn=$dbsn; user=$user; pass=****; filepath=$filepath; ruleSetName=$ruleSetName\n";
}

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/utility.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * Encapsulates the simple type, \c size_t.
 *
...
#  pragma warning (disable:1684)
    ...
    return
        ...
        static_cast<unsigned>(reinterpret_cast<ptrdiff_t>(a))
        // shift the next word's worth of high order bits to the bottom
        // and XOR them in, then stop looking.
        ^ static_cast<unsigned>(reinterpret_cast<ptrdiff_t>(a) >> rwIdHashShift);
#else
    ...
    return
        static_cast<unsigned>(reinterpret_cast<ptrdiff_t>(a))
        ^ (static_cast<unsigned>(reinterpret_cast<ptrdiff_t>(a) >> 3));

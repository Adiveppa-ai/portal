#ifndef EDR_FieldNotFoundException
#define EDR_FieldNotFoundException
// -*-C++-*-
...
// 31-Aug-2004  Giles Douglas       New inheritance hierarchy
//=============================================================================
...
namespace EDR 
{
	class FieldNotFoundException : public FieldException
	{
	public:
		FieldNotFoundException(pin_fld_num_t fld) : FieldException(fld) {};
	};
}

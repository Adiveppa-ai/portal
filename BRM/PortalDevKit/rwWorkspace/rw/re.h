 ...
 *
 * \brief
 * Deprecated. Provides extended regular expression matching similar to that
 * found in lex and awk.
 *
 * Class RWTRegularExpression represents an <em>extended</em> regular
 ...
 * Regular expressions can be of arbitrary size, limited by memory. The
 * extended regular expression features found here are a subset of those
 * found in the POSIX.2 standard (<em>ANSI/IEEE Std 1003.2, ISO/IEC
 * 9945-2)</em>.
 *
 ...
 * one-character RE that matches any of the characters in that set. This
 * means that \c [akm] matches either an "a", "k", or "m". A range of
 ...
 * caret (\c ^), then the RE matches any character except those in the set.
 * It does not match the empty string. For example: \c [^akm] matches any
 * character except "a", "k", or "m". The caret loses its special meaning if
 ...
 * subexpressions that can be treated as a single unit. For
 * -# A one-character RE followed by an asterisk (\c *) matches zero or more
 * occurrences of the RE. Hence, \c [a-z]* matches zero
 ...
 * occur zero or once in the string -- no more. For example,
 ...
 * the matched string must be at the beginning of the string
 ...
 *
 * The most frequent problem with use of this class is in being able to
 * specify a backslash character to be parsed. If you are attempting to
 * parse a regular expression that contains backslashes, you must be aware
 * that the C++ compiler and the regular expression constructor will both
 * assume that any backslashes they see are intended to escape the following
 * character. Thus, to specify a regular expression that exactly matches
 * \c "a\a", you would have to create the regular expression using four
 * backslashes as follows: the regular expression needs to see \c "a\\a",
 * and for that to happen, the compiler would have to see \c "a\\\\a".
 *
 * \code
...
public:
    ...
    /**
     * Construct a regular expression from the pattern given by \a pat. The
    ...
    /**
     * Recompiles self to the pattern given by \a pat. The status of the
    ...
    /**
     * Returns the index of the first instance in the string \a str that
     * matches the regular expression compiled in self, or #RW_NPOS if there
     * is no such match. The search starts at index \a start. The length of
     * the matching pattern is returned in the variable pointed to by
     * \a len. If an invalid regular expression is used for the search, an
     * exception of type RWInternalErr will be thrown. Note that this member
     * function is relatively clumsy to use -- class RWCString offers a
     * better interface to regular expression searches.
     */
     ...
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::OK</td>
     * <td>No errors</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::NOT_SUPPORTED</td>
     * <td>POSIX.2 feature not yet supported.</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::NO_MATCH</td>
     * <td>Tried to find a match but failed</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::BAD_PATTERN</td>
     * <td>Pattern was illegal</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::BAD_COLLATING_ELEMENT</td>
     * <td>Invalid collating element referenced</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::BAD_CHAR_CLASS_TYPE</td>
     * <td>Invalid character class type referenced</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::TRAILING_BACKSLASH</td>
     * <td>Trailing \ in pattern</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::UNMATCHED_BRACKET</td>
     * <td>[] imbalance</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::UNMATCHED_PARENTHESIS</td>
     * <td>() imbalance</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::UNMATCHED_BRACE</td>
     * <td>{} imbalance</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::BAD_BRACE</td>
     * <td>Content of {} invalid.</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::BAD_CHAR_RANGE</td>
     * <td>Invalid endpoint in [a-z] expression</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::OUT_OF_MEMORY</td>
     * <td>Out of memory</td>
     * </tr>
     * <tr>
     * <td>\c RWTRegularExpression::BAD_REPEAT</td>
 ...
 * \deprecated
 * As of SourcePro 4, use RWTRegex instead.
 * \relates RWTRegularExpression
 *
 * Class RWCRExpr represents an <em>extended</em> regular expression such as
 * those found in \c lex and \c awk. The constructor "compiles" the
 * expression into a form that can be used more efficiently. The results can
 * then be used for string searches using class RWCString. Regular
 * expressions can be of arbitrary size, limited by memory. The extended
 * regular expression features found here are a subset of those found in the
 * POSIX.2 standard (<em>ANSI/IEEE Std 1003.2, ISO/IEC 9945-2)</em>.
 *
 * The regular expression (RE) is constructed as follows:
 *
 * The following rules determine one-character REs that match a single

...
iScript
{
  ...
  {
      asnTreePushTag("RAP_0105.Acknowledgement");
      ...
      asnTreeAddString("TAP_0312.Sender.Sender",   edrString(HEADER.RECIPIENT) ); 
      asnTreeAddString("TAP_0312.Recipient.Recipient",edrString(HEADER.SENDER) );

      asnTreeAddString("TAP_0312.RapFileSequenceNumber.RapFileSequenceNumber",
                                                                sequenceNumber);

      asnTreePushTag("RAP_0105.AckFileCreationTimeStamp");
        addDateTimeLong(dateToStr(edrDate(HEADER.CREATION_TIMESTAMP)), 
      								  headerUtcTimeOffset);
      asnTreePop(); //asnTreePushTag("RAP_0105.AckFileCreationTimeStamp");

      asnTreePushTag("RAP_0105.AckFileAvailableTimeStamp");
        addDateTimeLong(dateToStr(edrDate(HEADER.TRANSMISSION_DATE)), 
      								  headerUtcTimeOffset);
      asnTreePop(); //asnTreePushTag("RAP_0105.AckFileAvailableTimeStamp");
    ...
    asnTreePop();	// asnTreePush("RAP_0105.Acknowledgement");
  }

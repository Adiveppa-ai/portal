#ifndef __rw_http_RWIHttpVersion_0_9_h__
#define __rw_http_RWIHttpVersion_0_9_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/http/RWIHttpVersion_0_9.h#1 $
 *
...
class
    ...
    RW_HTTP_GLOBAL RWIHttpVersion_0_9 : public RWIHttpVersion
{
...
inline
RWIHttpVersion_0_9::RWIHttpVersion_0_9(void)
{
}

inline bool
RWIHttpVersion_0_9::canPersist(void) const
{
    return false;
}

inline int
RWIHttpVersion_0_9::majorVersionNumber(void) const
{
    return 0;
}

inline int
RWIHttpVersion_0_9::minorVersionNumber(void) const
{
    return 9;
}

inline RWIHttpVersion*
RWIHttpVersion_0_9::clone(void) const
{
...
#endif // __rw_http_RWIHttpVersion_0_9_h__

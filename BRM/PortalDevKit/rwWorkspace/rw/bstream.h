 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/bstream.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWbistream specializes the abstract base class RWvistream to
 * restore variables stored in binary format by RWbostream.
 *
 * You can think of it as a binary veneer over an associated
 * \b std::streambuf. Because the RWbistream retains no information about
 * the state of its associated \b std::streambuf, its use can be freely
 * exchanged with other users of the \b std::streambuf (such as an
 ...
 * counterpart RWbistream.
 *
 * You can think of it as a binary veneer over an associated
 * \b std::streambuf. Because the RWbostream retains no information about
 * the state of its associated \b std::streambuf, its use can be freely
 * exchanged with other users of the \b std::streambuf (such as
 * \b std::ostream or \b std::ofstream).
 *
 * \note
 * Variables should not be separated with white space. Such white space
 * would be interpreted literally and would have to be read back in as a
 * character string.
 *

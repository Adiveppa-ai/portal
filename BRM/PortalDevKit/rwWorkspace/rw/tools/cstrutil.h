 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/cstrutil.h#1 $
 *
 **********************************************************************
 *
                        ...
                        const char* second, size_t secondLen)
{
    ...
    for (size_t i = 0; i < len; ++i) {
        int c1 = tolower(static_cast<unsigned char>(first[i]));
        int c2 = tolower(static_cast<unsigned char>(second[i]));
                        ...
                        const char* needle, size_t needleLen, size_t start)
{
    ...
    char u = (char)tolower(static_cast<unsigned char>(*needle));
    char l = (char)toupper(static_cast<unsigned char>(*needle));
    const char* pos = haystack + start;
    const char* end = haystack + haystackLen - needleLen;
    while (pos <= end) {
        if ((*pos == u || *pos == l) &&

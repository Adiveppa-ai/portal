...
/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/atomic.h#1 $
 *
 **********************************************************************
 *
...
public:
     ...
     * self. Returns the previous value of self.
     *
     * This function is equivalent to:
     *
     * \code
     ...
     *
     * \note
     * \a order values of #rw_mem_order_release and #rw_mem_order_acq_rel
     ...
     *
     * \note
     * \a order values of #rw_mem_order_consume, #rw_mem_order_acquire and
     * #rw_mem_order_acq_rel are not supported and will result in undefined
     * behavior.
     */

...
#    1 = (Default) The DM main process replaces any child DM processes
#          that fail. 
#========================================================================
END
...
END
	,"sm_svcname", "#- dm sm_svcname <service_name>"	
        ,"dm_init_be_timeout_description", <<END
#========================================================================
# dm_init_be_timeout
#
# (( THIS SECTION ADDED BY syncedstartstop ))
# timeout for dm_oracle child startup (post-fork): 2 * value == wait sec
#========================================================================
END
        ,"dm_init_be_timeout", "- dm dm_init_be_timeout 9999"
        ,"dm_primary_dbuser_description", <<END
#========================================================================
# dm_primary_dbuser
# set dm_primary_dbuser information for the secondary schema user
#========================================================================
END
        ,"dm_primary_dbuser", "- dm dm_primary_dbuser $PRIMARY_DB_USER"
        ,"aq_event_map_file_description", <<END
#========================================================================
# aq_event_map_file
...
#========================================================================
END
        ,"aq_event_map_file", "- dm aq_event_map_file ./aq_event_map"
 );

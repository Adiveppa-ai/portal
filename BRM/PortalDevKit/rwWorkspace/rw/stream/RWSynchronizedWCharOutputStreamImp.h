#ifndef rw_stream_RWSynchronizedWCharOutputStreamImp_h_
#define rw_stream_RWSynchronizedWCharOutputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWSynchronizedWCharOutputStreamImp.h#1 $
 *
 ...
 *
 * \headerfileloc{#include <rw/stream/RWSynchronizedWCharOutputStreamImp.h>}
 *
 * The typedef #RWSynchronizedWCharOutputStreamImp implements a simple wide
 * character lock output stream. The stream locks its internal
...
#endif // rw_stream_RWSynchronizedWCharOutputStreamImp_h_

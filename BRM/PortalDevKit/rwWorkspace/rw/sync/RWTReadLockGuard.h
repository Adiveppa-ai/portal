#ifndef __rw_sync_RWTReadLockGuard_h__
#define __rw_sync_RWTReadLockGuard_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/sync/RWTReadLockGuard.h#1 $
 *
...
#  define RWReadLockGuard RWTReadLockGuard
#endif
 ...
 *
 * \brief
 * A guard class that acquires read access to its resource upon creation and
 * releases it upon destruction.
 *
 * RWTReadLockGuard is a \e guard class that acquires read access on its
 ...
 * acquire read access on a mutex upon creation and release it when
 ...
 * {
 *     // acquire read access:
 *     RWTReadLockGuard<RWReadersWriterLock> lock(rwlock);
 *
 *     // ... critical section
 *
...
class RWTReadLockGuard : public RWTReadLockGuardBase<Resource>
{
public:
...
public:
    ...
    /**
     * Constructs an instance with the given resource and acquires read
...
private:
    ...
    operator=(const RWTReadLockGuard<Resource>& second);
...
template <class Resource>
inline
RWTReadLockGuard<Resource>::RWTReadLockGuard(Resource& res)
...
#endif // __rw_sync_RWTReadLockGuard_h__

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tpmset.h#1 $
 *
 **********************************************************************
 *
 ...
 * object, and allowing duplicate values.
 *
 ...
 * \c \<functional\> is an example. Note that items in the collection will be
 * dereferenced before being compared.
 *
 * RWTPtrMultiSet may contain multiple items that compare equal to each
 * other. (RWTPtrSet will not accept an item that compares equal to an item
 ...
 * \sa
 * \parblock
 * Class RWTPtrSet offers the same interface to a pointer-based collection
 * that will not accept multiple items that compare equal to each other.
 * RWTPtrMultiMap maintains a pointer-based collection of key-value pairs.
 *
 * Class <b>std::multiset<T*, key_compare,A ></b> is the C++ Standard
 ...
 *
 * \deprecated
 * As of SourcePro 12.5, use RWTPtrMultiSet::iterator to iterate over the
 * elements in this collection.
 *
 * \brief
 * Deprecated. Provides an iterator for RWTPtrMultiSet.
 *
 * RWTPtrMultiSetIterator provides an iterator interface to the C++ Standard
 * Library-based collection represented by RWTPtrMultiSet. (An STL iterator
 * interface is provided through RWTPtrMultiSet::iterator.)
 *
 * The order of iteration over an RWTPtrMultiSet is dependent upon the
...
public:
    /**
     * Creates an iterator for the multiset \a m. The iterator begins in an
    ...
    T* key() const
    {
        return *(const_cast<RWTPtrMultiSetIterator*>(this)->iter_);
    }
 ...
 *
 * \deprecated
 * As of SourcePro 12.5, use RWTPtrMultiSet::const_iterator to iterate over
 * the elements in this collection.
 *
 * \brief
 * Deprecated. Provides a \c const iterator for RWTPtrMultiSet.
 *
...
public:
    /**
     * Creates a \c const iterator for the multiset \a m. The iterator

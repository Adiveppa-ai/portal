...
iScript
{
  ...
  include "RAP_0104_MissingReturn.dsc";
  ...
  const Long RapReleaseVersionNumber        = 4;
...
//  Long    theTap3ReleaseVersionNumber;
  ...
  {
    asnTreeGetStoredNode(tapcurrencyInfoIdx);  // ie. asnTreePushTag("RAP_0103.RapBatchControlInfo");

    if( tapCurrency != "" and tapCurrency != "SDR" )
    {
      asnTreeAddString("TAP_0311.TapCurrency.TapCurrency", tapCurrency);
    }

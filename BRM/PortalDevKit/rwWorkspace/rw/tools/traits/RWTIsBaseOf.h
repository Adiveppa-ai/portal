 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTIsBaseOf.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \brief
 * Determines if a type is a base of another type
 *
 * If \c B is a base class of \c D, or if \c B and \c D are the same
 * non-union class type, regardless of cv-qualifiers, derives from

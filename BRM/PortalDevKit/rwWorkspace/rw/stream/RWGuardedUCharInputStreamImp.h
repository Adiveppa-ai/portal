#ifndef rw_stream_RWGuardedUCharInputStreamImp_h_
#define rw_stream_RWGuardedUCharInputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWGuardedUCharInputStreamImp.h#1 $
 *
 ...
 *
 * \headerfileloc{#include <rw/stream/RWGuardedUCharInputStreamImp.h>}
 *
 * The typedef #RWGuardedUCharInputStreamImp implements a simple Unicode
 ...
 *
 * A \ref rwGuard(RWUCharInputStream&) "rwGuard()" manipulator creates a
 ...
 * synchronized stream, the \ref rwGuard(RWUCharInputStream&) "rwGuard()"
 ...
 * \endexample
 */
RWUCharInputStream RW_STREAM_SYMBOLIC rwGuard(RWUCharInputStream& stream);

#endif // rw_stream_RWGuardedUCharInputStreamImp_h_

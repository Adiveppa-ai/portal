 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tqueue.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWTQueue represents a parameterized queue. Not only can the type of
 * object inserted into the queue be parameterized, but also the
 * implementation.
 *
 * Parameter \c T represents the type of object in the queue, either a class
 * or built-in type. The class \c T must have:
 *
 ...
 * RWTValDlist for this class to function as intended.
 *
 * Useful choices for \c C are RWTValSlist or RWTValDlist. Vectors, such as
 * RWTValOrderedVector, can also be used, but tend to be less efficient at
 * removing an object from the front of the queue.
 *
 * \synopsis
 * #include <rw/tqueue.h>
 * RWTQueue<T, C> queue;
...
public:
    ...
    /**
     * Returns the result of calling <tt>C::entries()</tt> on the underlying
     * container.
     */
    ...
    /**
     * Returns the result of calling <tt>C::first()</tt> on the underlying
     * container.
     */
    T first() const
    {
    ...
    /**
     * Returns the result of calling <tt>C::removeFirst()</tt> on the
    ...
    /**
     * Returns the result of calling <tt>C::isEmpty()</tt> on the underlying
     * container.
     */
    bool isEmpty() const
    {
    ...
    /**
     * Returns the result of calling <tt>C::last()</tt> on the underlying
     * container.
     */
    T last() const
    {

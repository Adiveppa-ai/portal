/* @(#)%Portal Version: FlistTimestampType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:43:43 % */
#ifndef EDR_FLISTTIMESTAMPTYPE_HPP
#define EDR_FLISTTIMESTAMPTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class FlistTimestampType.
//
//------------------------------------------------------------------------------
...
namespace EDR
{
/** <b><tt>FlistTimestampType</tt></b> is the FLIST_Timestamp datatype used in input files.
 *
 */
class FlistTimestampType : public FlistFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    FlistTimestampType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~FlistTimestampType();

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/mutex.h#1 $
 *
 **********************************************************************
 *
...
#    define RW_MUTEX_INIT(mutex) \
          rwMutexInit    (reinterpret_cast<_RTL_CRITICAL_SECTION*>(&mutex))

#    define RW_MUTEX_DESTROY(mutex) \
          rwMutexDestroy (reinterpret_cast<_RTL_CRITICAL_SECTION*>(&mutex))

#    define RW_MUTEX_LOCK(mutex) \
          rwMutexLock    (reinterpret_cast<_RTL_CRITICAL_SECTION*>(&mutex))

#    define RW_MUTEX_UNLOCK(mutex) \
          rwMutexUnlock  (reinterpret_cast<_RTL_CRITICAL_SECTION*>(&mutex))

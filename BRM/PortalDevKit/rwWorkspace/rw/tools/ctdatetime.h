 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/ctdatetime.h#1 $
 *
 **********************************************************************
 *
 ...
 * RWCollectable. This class is useful when date/time objects are used as
 * keys in the "dictionary" collection classes, or if date/time objects are
 * stored and retrieved as RWCollectable instances.
 *
...
public:
     ...
     */
    RWCollectableDateTime() : RWDateTime() { }
    ...
    /**
     * Returns the results of calling compareTo() for the base class
     * RWDateTime by using appropriate casts.
     */

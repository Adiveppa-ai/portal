...
TAP_0312
{
  ...
  {                      
    ...
    ElementId TAP_AsciiString(437, "Application"); 
  }                      
  ...
  {                      
    ...
    ElementType ASN_Integer(438, "Application"); 
  }                      
  ...
  {                      
    ...
    EventReference TAP_AsciiString(435, "Application"); 
  }                      
  ...
  MessagingEventService(ASN) 
  {                      
    Info                 
    {                    
    }                    
    MessagingEventService ASN_Integer(439, "Application"); 
  }                      
  ...
  MobileSessionService(ASN) 
  {                      
    Info                 
    {                    
    }                    
    MobileSessionService ASN_Integer(440, "Application"); 
  }                      
  ...
  NonChargedPartyNumber(ASN) 
  {                      
    Info                 
    {                    
    }                    
    NonChargedPartyNumber ASN_BcdString(444, "Application"); 
  }                      
                         
  NonChargedPublicUserId(ASN) 
  {                      
    Info                 
    {                    
    }                    
    NonChargedPublicUserId TAP_AsciiString(445, "Application"); 
  }                      

  RequestedDestination(ASN)
  {
    Info
    {
      Application = 450;
  ...
  RequestedNumber(ASN)
  {
    ...
    RequestedNumber ASN_BcdString(451, "Application");
  }

  RequestedPublicUserId(ASN)
  {
    Info
    {
    }
    RequestedPublicUserId TAP_AsciiString(452, "Application");
  }
  ...
  {                      
    ...
    PublicUserId TAP_AsciiString(446, "Application"); 
  }                      

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/cacheman.h#1 $
 *
 **********************************************************************
 *
...
public:
    ...
    /**
     * Performs any pending I/O operations. Returns \c true if the flush was
     ...
     * The data is put in the buffer pointed to by \a dat. This buffer must
     * be at least as long as the block size specified when the cache was
     * constructed. Returns \c true if the operation was successful,
     * otherwise \c false.
     */
    bool             read(RWoffset locn, void* dat);

    /**
     * Writes the block of data pointed to by \a dat to the offset \a locn
     * of the associated RWFile. The number of bytes written is given by the
     * block size specified when the cache was constructed. The actual write
     * to disk may be deferred. Use member function flush() to perform any
     * pending writes. Returns \c true if the operation was successful,
     * otherwise \c false.
     */

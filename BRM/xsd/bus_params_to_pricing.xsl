...
<xsl:stylesheet
        ...
        <xsl:template match="//bc:Param">
                        ...
                        <xsl:choose>
                                ...
                                <xsl:when test="$name = 'cache_references_at_start'">
                                        <xsl:element name="CacheReferencesAtStart">
                                                <xsl:choose>
                                                        <xsl:when test="$value = '1'">
                                                                <xsl:text>enabled</xsl:text>
                                                        </xsl:when>
                                ...
                                <xsl:when test="$name = 'log_price_change_event'">
                                        <xsl:element name="LogPriceChangeEvent">
                                                <xsl:choose>
                                                        <xsl:when test="$value = '1'">
                                                                <xsl:text>enabled</xsl:text>
                                                        </xsl:when>

 ...
 ***************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/randmlcg.h#1 $
 *
 ...
 *
 * \brief
 * Abstract base class for classes that generate random numbers uniformly
 * distributed over the interval <tt>[0,1]</tt>.
 *
 * Abstract base class for classes that generate random numbers uniformly
 * distributed over the interval <tt>[0, 1]</tt>.
 */
...
public:
    ...
    {
        return static_cast<unsigned long>(seed_);
    }

#ifndef __rw_smtp_pkgdefs_h__
#define __rw_smtp_pkgdefs_h__

/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/smtp/pkgdefs.h#1 $
 *
...
#include <rw/config/rwconfig_smtp.h>
...
//////////////////////////////////////////////////////////////////////////////
#if defined(_RWBUILD_smtp)
#  define RW_SMTP_BUILD
#endif
...
#  if defined(RW_SMTP_BUILD)
#    define RW_SMTP_GLOBAL                      RW_COMPILER_GLOBAL_EXPORT
#    define RW_SMTP_SYMBOLIC                    RW_COMPILER_SYMBOLIC_EXPORT
#  else
#    define RW_SMTP_GLOBAL                      RW_COMPILER_GLOBAL_IMPORT
#    define RW_SMTP_SYMBOLIC                    RW_COMPILER_GLOBAL_IMPORT
#  endif
#else
#  define RW_SMTP_GLOBAL
#  define RW_SMTP_SYMBOLIC
#endif
...
#define RW_SMTP_IDENT \
  static const char rw_smtp_ident[] = "\"@(#)\trw/smtp:" __FILE__ " " __DATE__ " " __TIME__ "\""; \
  inline void rw_use_smtp_ident(void) { RW_UNUSED(rw_smtp_ident); }

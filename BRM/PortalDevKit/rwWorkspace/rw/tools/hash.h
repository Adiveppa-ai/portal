...
/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/hash.h#1 $
 *
 **********************************************************************
 *
 ...
 * for use with hash or unordered containers. The primary template definition
 * is not defined. Specializations of this class are expected to:
 *
 * - Conform to the interface of \c std::unary_function<T, size_t>.
 * Specifically they must provide a typedef of \c T to \c argument_type and
 * of \c size_t to \c result_type.
 * - Define <tt>operator() const</tt> such that it takes a single argument
 * of type \c argument_type and returns \c result_type.
 ...
 *
 * \brief
 * Function object for hashing a \c bool.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 ...
 *
 * \brief
 * Function object for hashing a \c char.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a <tt>signed char</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing an <tt>unsigned char</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a \c wchar_t.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a \c short.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing an <tt>unsigned short</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing an \c int.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing an <tt>unsigned int</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a \c long.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing an <tt>unsigned long</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a <tt>long long</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing an <tt>unsigned long long</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a \c float.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
 ...
 *
 * \brief
 * Function object for hashing a \c double.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
...
struct RWTHash<double> : public std::unary_function<double, size_t> {
    ...
    {
#if defined(RW_GCC_VERSION) && (RW_GCC_VERSION >= 40100 && RW_GCC_VERISON < 40400)
        rwuint64 tmp = 0;
        rw_memcpy_s(&tmp, sizeof(rwuint64), &obj, sizeof(double));
        return rwHash(tmp);
#else
        // Temporary required to avoid type-punning warnings with
        // GCC 4.1.2
 ...
 *
 * \brief
 * Function object for hashing a <tt>long double</tt>.
 *
 * Provides a C++ Standard Library-compliant hash function object suitable
 * for use with hash or unordered containers.
 */
...
struct RWTHash<long double> : public std::unary_function<long double, size_t> {
    ...
    {
        return RWTHash<double>()(static_cast<double>(obj));
    }
};

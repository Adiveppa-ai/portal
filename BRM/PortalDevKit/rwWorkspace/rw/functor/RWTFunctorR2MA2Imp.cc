/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/functor/RWTFunctorR2MA2Imp.cc#1 $
 *
 ...
 * Description:
 *
 * Provides definition of class RWTFunctorR2MA2Imp.
 *
 *************************************************************************/
...
SR
RWTFunctorR2MA2Imp<SR, S1, S2, Callee, DR, D1, D2, A1, A2>::run(S1 s1, S2 s2) const
{

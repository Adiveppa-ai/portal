...
public:
    ...
    /**
     * Default constructor. Creates an empty object. Post-condition: for any
     * \c T, <tt>(address\<T\>() == 0)</tt>.
     */
    RWAny()
        : imp_(0)
    {
    ...
    /**
     * Assignment operator. Deep-copies \a ref. Returns a reference to self.
     */
    ...
    /**
     * Template assignment operator for type \c any holding \c T. Assigns
     * self to hold copy of argument \a ref.
     */
    template<typename T>
    ...
    /**
     * Implements a swap operation. After the swap, \c this object contains
     * the old content of the argument and vice versa.
     */
    ...
    /**
     * Implements type retrieval. Returns <tt>&typeid (T)</tt> if \c any
     * holds an object of type \c T, or \c 0 otherwise.
     */
    ...
    /**
     * Implements value retrieval. Returns <tt>*address\<T\>()</tt> if \c T
     * is the type of the object stored in self, or throws an exception of
     * type (or a type derived from) \b std::bad_cast otherwise.
     */
    template<class T>
    T&  get()
    {
    ...
    /**
     * Implements address retrieval. Returns the address of the object held
     * in \c any or \c 0 if the object is not of the type requested.
     */
    template<class T>
    T* address()
    {

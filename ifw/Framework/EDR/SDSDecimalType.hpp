#ifndef EDR_SDSDECIMALTYPE_HPP
#define EDR_SDSDECIMALTYPE_HPP
...
namespace EDR
{
	class SDSDecimalType: public FieldDescr D_THREADINFO_M
	{
		D_SINGLETHREADED

	public:
		SDSDecimalType(const BAS::String& name = BAS::NULL_STRING);

		virtual ~SDSDecimalType();

 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTIsFunction.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \note
 * For compilers without variadic template support, this trait is only
 * implemented for functions of up to 10 arguments.
 *
 * \example
 * \code
...
#if !defined(RW_NO_VARIADIC_TEMPLATES)

template <typename R, typename... Args>
struct RWTIsFunction< R(Args...) > : public RWTrueType {
};

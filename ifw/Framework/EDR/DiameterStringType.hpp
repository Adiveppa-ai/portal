/* @(#)%Portal Version: DiameterStringType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:43:20 % */
#ifndef EDR_DIAMETERSTRINGTYPE_HPP
#define EDR_DIAMETERSTRINGTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class DiameterStringType
//
//------------------------------------------------------------------------------
// Revision       1.0  2005/02/08 mliu
...
namespace EDR
{
/** <b><tt>DiameterStringType</tt></b> is the DiameterString datatype used in input files.
 *
 */
class DiameterStringType : public DiameterFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    DiameterStringType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~DiameterStringType();

    //@}
    
    /**@name DiameterStringType public methods */
    //@{
...
#endif // EDR_DIAMETERSTRINGTYPE_HPP

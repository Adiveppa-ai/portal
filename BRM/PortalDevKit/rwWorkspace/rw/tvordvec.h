 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tvordvec.h#1 $
 *
 **********************************************************************
 *
 ...
 * \sa
 * \parblock
 * Classes RWTValDeque, RWTValSlist, and RWTValDlist also provide a Rogue
 * Wave interface to C++ Standard Library sequence collections.
 *
...
#  endif // !RW_NO_RVALUE_REFERENCES
    ...
    /**
     * Returns the position of the first item \c t in self such that (t ==
...
#  endif // !RW_NO_RVALUE_REFERENCES
     ...
     *
     * \exception RWBoundsErr
     * Thrown if this position is not between \c 0 and one less than the
    ...
    /**
     * Replaces all elements \c t in self with \a newVal such that the
    ...
    /**
     * Returns a pointer to the first element of the vector. The value
     * returned is undefined if the vector is empty.
     */
    pointer data()
    {
    ...
    /**
     * Modifies the capacity of the vector to be at least as large as \a n.
     * The function has no effect if the capacity is already as large as
     * \a n.
     */
...
#  endif // !RW_NO_RVALUE_REFERENCES
    ...
    /**
     * Constructs a vector with \a n elements, each initialized to \a val.
     */
 ...
 * vector.
 *
 * Class \c A is an allocator of objects of type \c bool. For more
 ...
 * representation of the boolean array and it does not provide a \b data()
 * member function.
 *
 * \synopsis
 * #include <rw/tvordvec.h>
 ...
 * Wave interface to C++ Standard Library sequence collections.
 *
 * Class RWTValOrderedVector provides a generic vector for non-boolean
 * types.
 *
...
public:
    ...
    /**
     * Inserts \a val into self at position \a pos. Returns an iterator for

#ifndef __rw_network_RWTimedPortalImp_h__
#define __rw_network_RWTimedPortalImp_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/network/RWTimedPortalImp.h#1 $
 *
...
class RWTimedPortalImp
    : public RWPortalImp, protected RWPortal
{
public:
    RWTimedPortalImp(const RWPortal&, unsigned long timeout);
...
private:
    ...
    RWTimedPortalImp(const RWTimedPortalImp&);
    RWTimedPortalImp& operator=(const RWTimedPortalImp&);
};

#endif  // __rw_network_RWTimedPortalImp_h__ 

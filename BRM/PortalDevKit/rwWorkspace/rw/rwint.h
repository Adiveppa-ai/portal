 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/rwint.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * Useful as a base class for classes that use integers as keys in
 * dictionaries, and so forth
 *
 * Integer class. This class is useful as a base class for classes that use
 * integers as keys in dictionaries, and so forth.
 *
 * \synopsis
 * #include <rw/rwint.h>
 * RWInteger i;
...
public:
    ...
    /**
     * Changes the value of the RWInteger to \a newval and returns the old
     * value.
     */
...
/**
 * \relates RWInteger
 * Restores an RWInteger into \a x from a virtual stream, replacing the
 * previous contents of \a x.
 */
inline RWvistream&
...
/**
 * \relates RWInteger
 * Restores an RWInteger into \a x from an RWFile, replacing the previous
 * contents of \a x.
 */
inline RWFile&

 ...
 *
 * $Id: //spro/rel2016.1/rw/dcomplex.h#1 $
 *
...
#if defined(_DEBUG) && defined(_WIN32) && defined(__INTEL_COMPILER) && _MSC_VER <= 1900
...
{
    return std::pow(static_cast<std::complex<double> >(x), static_cast<std::complex<double> >(x));
}
#else
/**
 * \ingroup essential_math_module
 *

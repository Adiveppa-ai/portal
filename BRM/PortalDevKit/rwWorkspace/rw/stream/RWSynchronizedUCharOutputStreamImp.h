#ifndef rw_stream_RWSynchronizedUCharOutputStreamImp_h_
#define rw_stream_RWSynchronizedUCharOutputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWSynchronizedUCharOutputStreamImp.h#1 $
 *
 ...
 *
 * \headerfileloc{#include <rw/stream/RWSynchronizedUCharOutputStreamImp.h>}
 *
 * The typedef #RWSynchronizedUCharOutputStreamImp implements a simple
 * Unicode character lock output stream. The stream locks its internal
 * synchronization mechanism before forwarding output requests to its
 * associated sink stream, and then unlocks the internal synchronization
...
#endif // rw_stream_RWSynchronizedUCharOutputStreamImp_h_

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/decbase.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * The base class for the different RWDecimal classes. This class provides
 * the definition of enums used in the derived classes and in the related
 * classes RWDecimalInexactErr and RWDecimalOverflowErr.
 */
...
public:
     ...
     *
     * The following table shows the results of the different rounding
     * methods.
     *
     * <table>
     * <tr>
     ...
     *
     * Any operation on \c ctorError or \c missingstate returns a result
     * with the State \c ctorError or \c missingstate respectively.
     *
     ...
     *
     * \note
     * An operation on an object with \c SNaNstate does not generate
     * signals, unless converted to a double or long double and used in
     * double arithmetic.
     */
    ...
    /**
     * An enumeration defining the operation that caused the error handler
     * to be called.
     *
     * \sa

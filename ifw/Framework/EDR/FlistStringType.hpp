/* @(#)%Portal Version: FlistStringType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:43:50 % */
#ifndef EDR_FLISTSTRINGTYPE_HPP
#define EDR_FLISTSTRINGTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class FlistStringType.
//
//------------------------------------------------------------------------------
// Revision       1.0  2004/06/28 ammon
...
namespace EDR
{
/** <b><tt>FlistStringType</tt></b> is the FLIST_String datatype used in input files.
 *
 */
class FlistStringType : public FlistFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    FlistStringType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~FlistStringType();

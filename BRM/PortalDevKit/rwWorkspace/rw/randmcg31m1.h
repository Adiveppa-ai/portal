 ...
 ***************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/randmcg31m1.h#1 $
 *
 ...
 * generators derived from abstract base class RWTRand.
 *
 ...
 * \f]
 *
 * Unlike RWRandGenerator, each instance of RWRandGenMCG31M1 contains and
 * maintains its own, independent state. This can make it easier to use in
 * some situations. The "internal state" of an instance of RWRandGenMCG31M1

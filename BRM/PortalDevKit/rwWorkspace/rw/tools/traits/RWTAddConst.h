 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTAddConst.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \brief
 * Adds \c const qualification to a type
 *
 * Specifies a typedef \c type to a <tt>const</tt>-qualified version of
 * \c T. If \c T is a function, reference, or is already \c const, \c type
 * will be a typedef to \c T.
 *
 * \example
 * \code

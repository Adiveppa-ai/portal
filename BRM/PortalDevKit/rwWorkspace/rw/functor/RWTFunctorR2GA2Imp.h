#ifndef __rw_functor_RWTFunctorR2GA2Imp_h__
#define __rw_functor_RWTFunctorR2GA2Imp_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/functor/RWTFunctorR2GA2Imp.h#1 $
 *
...
#  define RWFunctorR2GA2Imp RWTFunctorR2GA2Imp
#  define rwMakeFunctorR2GA2 rwtMakeFunctorR2GA2

//-- Group: RWTFunctorR21Imp
//--
//-- Example:
//--   int foo(short s, long l, char c, float) { return s; }
//--
//--   int main () {
//--
//--        // Create an RWTFunctorR2 with two callee arguments.
//--     RWTFunctorR2<int,short,long> functor =
//--        rwtMakeFunctorR2((int(*)(short,long))0, foo, 't', 4.3);
//--
//--        // Invoking 'functor' will call foo.
//--     int return_value = functor(3, 5309);
//--
//--     return 0;
//--   }
//--
...
class RWTFunctorR2GA2Imp : public RWTFunctorR2Imp<SR, S1, S2>
{

public:

    // Destructor
    ~RWTFunctorR2GA2Imp(void);
    ...
    //-- Creates a new RWTFunctorR2GA2Imp and returns an appropriate handle.
...
protected:
    ...
    RWTFunctorR2GA2Imp(CalleeSignature function, A1 a1, A2 a2);

private:

    RWTFunctorR2GA2Imp(const RWTFunctorR2GA2Imp& second);

    RWTFunctorR2GA2Imp&
    operator=(const RWTFunctorR2GA2Imp& second);
...
//-- A macro for ease of use in creating new 'RWTFunctorR2GA2Imp' bodies.
 ...
 */
RW_DEPRECATE_MACRO("rwtMakeFunctorR2GA2", "Use rwBind() instead")
#define rwtMakeFunctorR2GA2(SR,S1,S2,DR,function,D1,D2,A1,a1,A2,a2) \
   RWTFunctorR2GA2Imp<SR,S1,S2,DR,D1,D2,A1,A2 >::make(function,a1,a2)

template <class SR, class S1, class S2, class DR, class D1, class D2, class A1, class A2>
inline RWTFunctorR2<SR, S1, S2>
RWTFunctorR2GA2Imp<SR, S1, S2, DR, D1, D2, A1, A2>::make(CalleeSignature function, A1 a1, A2 a2)
{
    return new RWTFunctorR2GA2Imp<SR, S1, S2, DR, D1, D2, A1, A2>(function, a1, a2);
}

template <class SR, class S1, class S2, class DR, class D1, class D2, class A1, class A2>
inline
RWTFunctorR2GA2Imp<SR, S1, S2, DR, D1, D2, A1, A2>::RWTFunctorR2GA2Imp(CalleeSignature function,
        A1 a1, A2 a2)
    : function_(function),
      a1_(a1),
      a2_(a2)
...
template <class SR, class S1, class S2, class DR, class D1, class D2, class A1, class A2>
inline
RWTFunctorR2GA2Imp<SR, S1, S2, DR, D1, D2, A1, A2>::~RWTFunctorR2GA2Imp(void)
{
}

#if defined(RW_NO_IMPLICIT_INCLUSION)
#  include <rw/functor/RWTFunctorR2GA2Imp.cc>
#endif

RW_RESTORE_DEPRECATED_WARNINGS
#endif

#endif // __rw_functor_RWTFunctorR2GA2Imp_h__

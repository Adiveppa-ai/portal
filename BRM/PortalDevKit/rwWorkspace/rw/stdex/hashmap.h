...
/**********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stdex/hashmap.h#1 $
 *
 **********************************************************************
 *
 ...
 * implemented as a hash table of \b std::pair<const K,V> instances.
 *
 ...
 * the ANSI <em>associative container</em> specification, rw_hashmap
...
public:
    ...
    /**
     * \deprecated
     * As of SourcePro 12.5, use \ref rw_hashmap::hasher "hasher" instead.
     *
     * A type representing the hash function.
     */

/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/functor/RWTFunctorR1.cc#1 $
 *
...
/*****************************************************************************
   ...
   RWTFunctorR1<SR,S1> - Handle class for RWTFunctorR1Imp functor family
...
{
    if (&second != this) {
        RWTFunctor<SR(S1)>::operator=(second);
    }
    return *this;
}

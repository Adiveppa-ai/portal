...
#define RW_CURRENCY_MP2INT_H

/*--------------------------------------------------------------
 *
 * Type definition for RWMP2Int.
 *
 * $Id: //spro/rel2016.1/rw/currency/mp2int.h#1 $
 *
...
#ifndef RW_MONEY_MP2INT_H
#  define RW_MONEY_MP2INT_H
#endif
...
RWDCML_INSTANTIATE_1(class RW_DCML_GLOBAL RWMultiPrecisionInt<2>);

#endif  // RW_CURRENCY_MP2INT_H

/* @(#)%Portal Version: FlistIndexType.hpp:NewPipelineVelocityInt:2:2006-Sep-18 22:43:57 % */
#ifndef EDR_FLISTINDEXTYPE_HPP
#define EDR_FLISTINDEXTYPE_HPP
//==============================================================================
//
...
//------------------------------------------------------------------------------
// Module Description:
//   Declaration of the class FlistIndexType.
//
//------------------------------------------------------------------------------
...
/** <b><tt>FlistIndexType</tt></b> is the FlistIndexType datatype used in input files.
 *
 */
class FlistIndexType : public FlistFieldDescr D_THREADINFO_M
{
  D_SINGLETHREADED
  ...
  public:
     ...
     */
    FlistIndexType( const BAS::String& name = BAS::NULL_STRING );

    /** Destructor
     */
    virtual ~FlistIndexType();

    //@}

    /**@name FlistIndexType public methods */
    //@{
    ...
    /** Write out the index to a string buffer

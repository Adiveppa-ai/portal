 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tpordvec.h#1 $
 *
 **********************************************************************
 *
 ...
 * a vector. Class \c T is the type pointed to by the items in the
 ...
 * \sa
 * \parblock
 * Classes RWTPtrDeque, RWTPtrSlist, and RWTPtrDlist also provide a Rogue
...
public:
    ...
    /**
     * Clears the collection by removing all items from self. Does not call
     * <tt>operator delete</tt> on the individual items.
     */
    void clear()
    {
        std().clear();
...
#  endif // !RW_NO_RVALUE_REFERENCES
    ...
    /**
     * Constructs a vector with \a n elements, each initialized to \a a.
     */

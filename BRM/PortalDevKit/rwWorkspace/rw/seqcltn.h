 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/seqcltn.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * Class RWSequenceable is an abstract base class for collections that can
 * be accessed by an index. It inherits class RWCollection as a public base
...
public:
    ...
    /**
     * Adds \a a to the end of the collection and returns it. Returns #rwnil
     ...
     * The return value can be used as an lvalue. The index \a i must be
     * between zero and the number of items in the collection less one, or
    ...
    /**
     * Allows access to the \a i <sup>th</sup> element of the collection.
     * The return value cannot be used as an lvalue. The index \a i must be
     * between zero and the number of items in the collection less one, or
     * an exception of type RWBoundsErr will be thrown.
     */
     ...
     * pointed to by \a c. If there is no such item, returns #RW_NPOS. For
     ...
     * \a indx must be between \c 0 and the number of items in the
    ...
    /**
     * Adds \a c to the beginning of the collection and returns it. Returns

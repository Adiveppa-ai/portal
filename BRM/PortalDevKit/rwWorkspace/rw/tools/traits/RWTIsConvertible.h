 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTIsConvertible.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \brief
 * Determines if a type \c T is convertible to a type \c U
 *
 ...
 * compilation failures when using this trait. For portability, the
 * following conversions should be avoided or otherwise guarded against.

 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tpdeque.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * A pointer-based collection of values, implemented as a double-ended
 * queue, or deque.
 *
 * This class maintains a pointer-based collection of values, implemented as
 * a double-ended queue, or deque. Class \c T is the type pointed to by the
 * items in the collection. Class \c A is an allocator of objects of class
 ...
 * \sa
 * \parblock
 * Classes RWTPtrDlist, RWTPtrSlist, and RWTPtrOrderedVector also provide a
 * Rogue Wave pointer-based interface to standard sequence collections.
 *
 * Class \b std::deque<T*,A> is the C++ Standard Library collection that
 ...
 *
 * \example
 * In this example, a double-ended queue of \c ints is exercised.
 *
 * \code
 * // tpdeque.cpp
 * #include <iostream>
...
public:
    ...
    /**
     * Removes all items from the collection <em>and</em> uses

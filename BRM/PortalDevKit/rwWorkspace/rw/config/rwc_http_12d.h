...
#if defined _RW_http_CONFIG
#  if _RW_http_CONFIG != 0x5258fb32
#    error  Error, two different configurations given for http-library
#  endif
#else
// Define configuration id
#define _RW_http_CONFIG 0x5258fb32
...
#define RW_HTTP_VERSION 0x16010000
/* #define RW_HTTP_DEBUG 0 */
#define RW_HTTP_DLL 1


inline const char * rw_http_library_id() { return "rw_http_Edition_2016_1__12d__2017_4_20_09_43_55_053"; }
static const char *  rw_http_Edition_2016_1__12d__2017_4_20_09_43_55_053 = rw_http_library_id();

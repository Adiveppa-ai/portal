/*	
 *	@(#)%Portal Version: pin_sim.h:CommonIncludeInt:3:2006-Sep-11 05:23:54 %
 *	
...
typedef enum pin_sim_state_type {
	...
	PIN_SIM_INVALID_STATE			=	10000
	/*PIN_SIM_INVALID_STATE is added just to assign it as default value. 
	 * we have added larger value so that if tomorrow if new values are added we dont have to modify 
	 * PIN_SIM_INVALID_STATE*/

...
{
    my $xmlfile = ();
    sub setXmlFile { my $self = shift; $xmlfile = shift }
    sub getXmlFile { return $xmlfile }
}
...
# this function will modify the same xml file.

sub modifyNode
{
    my ($self, $tag_path, $new_value) = @_;
    ...
    my @tags_list = split('\.', $tag_path);
    my $tag = shift @tags_list;

 ...
 *
 * $Id: //spro/rel2016.1/rw/tools/traits/RWTRemoveCV.h#1 $
 *
 ***************************************************************************/
 ...
 *
 * \brief
 * Removes cv-qualification from a type
 *
 * Specifies a typedef \c type to \c T with all cv-qualifications removed.
 * If \c T is a "<tt>const T1</tt>", "<tt>volatile T1</tt>", or

 ...
 *
 * $Id: //spro/rel2016.1/rw/mathdefs.h#1 $
 *
...
#    endif
#    if (_MSC_VER <= 1900)   // VC 14.0 and before require explicit instantiation.
...
#if defined(RW_USING_CLAPACK) && defined(RW_SHARED) && defined(__HP_aCC) && (__HP_aCC <= 62802)

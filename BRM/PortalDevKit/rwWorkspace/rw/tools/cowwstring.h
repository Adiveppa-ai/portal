 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/tools/cowwstring.h#1 $
 *
 **********************************************************************
 *
 ...
 * is defined.
 *
 * RWCopyOnWriteWSubString should be directly used only with instances of
 * class RWCopyOnWriteWString. RWWSubString should be used with instances of
 * class RWWString.
 *
 * \sa
 ...
 * of class RWCopyOnWriteWString. RWWConstSubString should be used with
 * instances of class RWWString.
 *
 * \sa
...
{
    assertElement(static_cast<size_t>(i));

#ifndef rw_stream_RWCharArrayOutputStreamImp_h_
#define rw_stream_RWCharArrayOutputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWCharArrayOutputStreamImp.h#1 $
 *
 ...
 *
 * \brief
 * Abstract base class for narrow character output streams that allow
 * retrieval of their inserted data as a character array.
 *
 * Abstract base class for narrow character output streams that support an
 * extended interface that allows retrieval of their inserted data as a
 * character array. Implements the body idiom from the handle-body pattern.
 */
class RW_STREAM_GLOBAL RWCharArrayOutputStreamImp : public RWCharOutputStreamImp
{
...
#endif // rw_stream_RWCharArrayOutputStreamImp_h_

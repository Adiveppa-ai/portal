...
APPEND
   ...
   (
	...
	PRICE_LIST_NAME               	CHAR TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"',
	RETRY_COUNT    			INTEGER EXTERNAL TERMINATED BY ',',
	NEXT_RETRY_T   			INTEGER EXTERNAL TERMINATED BY ',',
	CALENDAR_DOM			INTEGER EXTERNAL TERMINATED BY ',',
	GRACE_PERIOD			INTEGER EXTERNAL TERMINATED BY ',',
	RENEWAL_MODE                    INTEGER EXTERNAL TERMINATED BY ',',
	BASE_PRODUCT_OBJ_DB             INTEGER EXTERNAL TERMINATED BY ',',
	BASE_PRODUCT_OBJ_TYPE           CHAR TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"',
	BASE_PRODUCT_OBJ_ID0            INTEGER EXTERNAL TERMINATED BY ',',
	OFFERING_OVERRIDE_VALUES_OBJ_DB     		INTEGER EXTERNAL TERMINATED BY ',',
	OFFERING_OVERRIDE_VALUES_OBJ_ID0     		INTEGER EXTERNAL TERMINATED BY ',',
-- Constant values
	...
	BASE_PRODUCT_OBJ_REV		CONSTANT '0',
	OFFERING_OVERRIDE_VALUES_OBJ_TYPE		CONSTANT '/offering_override_values',
	OFFERING_OVERRIDE_VALUES_OBJ_REV		CONSTANT '0'

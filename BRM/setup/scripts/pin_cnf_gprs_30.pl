...
%GPRS_MANAGER_CM_PINCONF_ENTRIES = (
  "gprs_manager_fm_required_description", <<END
#========================================================================
# gprs_manager_fm_required
#
...
#=======================================================================
END
  , "gprs_manager_fm_required", <<END
- cm fm_module \$\{PIN_HOME\}/lib/fm_tcf_gprs_pol\$\{LIBRARYEXTENSION\} fm_gprs_pol_config$FM_FUNCTION_SUFFIX - pin
- cm fm_module \$\{PIN_HOME\}/lib/fm_tcf_gprs\$\{LIBRARYEXTENSION\} fm_gprs_config$FM_FUNCTION_SUFFIX - pin
END

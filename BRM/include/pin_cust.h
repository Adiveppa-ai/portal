/*******************************************************************
 *      @(#)$Id: pin_cust.h /cgbubrm_mainbrm.portalbase/2 2023/11/20 17:23:00 shic Exp $
 *
...
#define PIN_OBJ_NAME_EVENT_NOTIFY_SERVICE_AAC_MODIFY "Service Object AAC field modification Log"
#define PIN_OBJ_TYPE_EVENT_DESCR_AAC	"AAC fields update event"
...
#define PIN_OBJ_TYPE_EVENT_NOTIFY_SERVICE_AAC_MOIDFY "/event/notification/service/aac/modify"
...
typedef enum {
	...
	PIN_STATUS_FEA_ERA_INVALID			= 10000
	/*PIN_STATUS_FEA_ERA_INVALID is added just to assign it as default value. 
	 * we have added larger value so that if tomorrow if new values are added we dont have to modify 
	 * PIN_STATUS_FEA_ERA_INVALID*/
...
#define PIN_TRANS_NAME_PREP_COMMIT "prep_commit"

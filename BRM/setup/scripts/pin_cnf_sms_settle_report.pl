...
$SMS_SETTLE_REPORT_PINCONF_HEADER  =  <<END
#************************************************************************
# Configuration File for Portal Sms Settle Report Module
#
#
...
%SMS_SETTLE_REPORT_CM_PINCONF_ENTRIES = (
  "sms_settle_report_fm_required_description", <<END
#========================================================================
# sms_settle_report_fm_required
#
...
#=======================================================================
END
  , "sms_settle_report_fm_required", <<END
- cm fm_module \$\{PIN_HOME\}/lib/fm_ic\$\{LIBRARYEXTENSION\} fm_ic_config$FM_FUNCTION_SUFFIX - pin

#ifndef rw_stream_RWFilteredCharInputStreamImp_h_
#define rw_stream_RWFilteredCharInputStreamImp_h_

/*********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/stream/RWFilteredCharInputStreamImp.h#1 $
 *
 ...
 *
 * \brief
 * Abstract base class for all the filtered narrow character input stream
 ...
 */
class RW_STREAM_GLOBAL RWFilteredCharInputStreamImp : public RWCharInputStreamImp
{
...
public:
    ...
    /**
     * Forwards the reading of a single narrow character from the attached
     * source stream.
     */
    virtual char read();

    /**
     * Forwards the reading of an array of narrow characters from the
     * attached source stream. The function returns the actual number of
     * narrow characters read.
     *
     * \param charArray
     * A pointer to the first element of the array. The array must have been
     * pre-allocated to contain at least \a numChars elements.
     *
     * \param numChars
     ...
     *
     * \param numUnits
     * The number of narrow character(s) to be skipped.
     */
...
#endif // rw_stream_RWFilteredCharInputStreamImp_h_

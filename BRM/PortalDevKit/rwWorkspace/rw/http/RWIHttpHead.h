#ifndef __rw_http_RWIHttpHead_h__
#define __rw_http_RWIHttpHead_h__
/**************************************************************************
 *
 * $Id: //spro/rel2016.1/rw/http/RWIHttpHead.h#1 $
 *
...
class
    ...
    RW_HTTP_GLOBAL RWIHttpHead : public RWIHttpMethod
{
...
inline
RWIHttpHead::RWIHttpHead(const RWCString& uri)
    : RWIHttpMethod(uri)
{
}

inline RWCString
RWIHttpHead::name(void) const
{
    return HTTP_HEAD;
}
...
#endif // __rw_http_RWIHttpHead_h__

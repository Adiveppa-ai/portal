 ...
 **********************************************************************
 *
 * $Id: //spro/rel2016.1/rw/idendict.h#1 $
 *
 **********************************************************************
 *
 ...
 *
 * \brief
 * A hash table for key-value pairs. Items are found by requiring them to be
 * identical
 *
 ...
 * requiring that they be \e identical (i.e., have the same address) as the
 * key, rather than being equal (i.e., test \c true for
 * \ref RWCollectable::isEqual() "isEqual()").
 *
 * <em>Both keys and values must inherit from the abstract base class</em>
 * RWCollectable.
 *
...
public:
    ...
    /**
     * Constructs an empty identity dictionary with
    ...
    /**
     * Move constructor. The constructed RWIdentityDictionary takes
     * ownership of the data owned by \a h.
     *
     * \conditional
     ...
     * of self has a counterpart in \a h which
     * \ref RWCollectable::isEqual() "isEqual()".
     */

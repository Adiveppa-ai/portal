/*	
 *	@(#)%Portal Version: pin_zonemap.h:CommonIncludeInt:2:2006-Sep-11 05:24:08 %
 *	
...
#ifndef lint
static char    *_1_pin_zonemap_h = "@(#) %filespec: pin_zonemap.h~9 %  (%full_filespec: pin_zonemap.h~9:incl:1 %)";
#endif
